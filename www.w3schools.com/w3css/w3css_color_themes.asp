...
<html lang="en-US">
<head>
<title>W3.CSS Color Themes</title>
<meta charset="utf-8">
...
<h1>W3.CSS <span class="color_h1">Color Themes</span></h1>

<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="w3css_color_schemes.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="w3css_color_generator.asp">Next &#10095;</a>
</div>

<hr>
<h2>Color Themes</h2>
<p>With W3.CSS, it is easy to customize your applications with color themes.</p>

<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-half">
<div class="w3-card-4">
  <div class="w3-container w3-card-4" style="background-color:#265728;color:white">
    <h3>Movies 2014</h3>
  </div>
  <ul class="w3-ul"  style="background-color:#dbefdc">
    <li>
      <h4>Frozen</h4>
      <p>The response to the animations was ridiculous</p>
    </li>
    <li style="background-color:#b7dfb8">
  ...
  <div class="w3-container w3-xlarge" style="background-color:#3d8b40;color:white">
    &laquo;<span class="w3-right">&raquo;</span>
  </div>
</div>
</div>
<div class="w3-half">
<div class="w3-card-4">
  <div class="w3-container w3-card-4" style="background-color:#303030;color:white">
    <h3>Movies 2014</h3>
  </div>
  <ul class="w3-ul" style="background-color:#dfdfdf">
    <li>
      <h4>Frozen</h4>
      <p>The response to the animations was ridiculous</p>
    </li>
  ...
  <div class="w3-container w3-dark-grey w3-xlarge">
    &laquo;<span class="w3-right">&raquo;</span>
  </div>
</div>
</div>
...
<p>All you have to do is add a link to a predefined (or home made) theme:</p>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;link rel="stylesheet" 
href="https://www.w3schools.com/w3css/4/w3.css"&gt;<br>&lt;link rel="stylesheet" 
href="<strong>https://www.w3schools.com/lib/w3-theme-indigo.css</strong>"&gt;</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_theme_indigo" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Predefined Themes</h2>
<p>These are the predefined themes in W3.CSS:</p>

<table class="w3-table w3-bordered w3-border w3-large">
 <tr>
  <td class="w3-text-red">w3-theme-red</td>
  <td width="10"><a target="_blank" class="w3-btn w3-medium w3-right w3-red" href="tryit.asp?filename=tryw3css_theme_red">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-pink">w3-theme-pink</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-pink" href="tryit.asp?filename=tryw3css_theme_pink">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-purple">w3-theme-purple</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-purple" href="tryit.asp?filename=tryw3css_theme_purple">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-deep-purple">w3-theme-deep-purple</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-deep-purple" href="tryit.asp?filename=tryw3css_theme_deep-purple">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-indigo">w3-theme-indigo</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-indigo" href="tryit.asp?filename=tryw3css_theme_indigo">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-blue">w3-theme-blue</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-blue" href="tryit.asp?filename=tryw3css_theme_blue">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-light-blue">w3-theme-light-blue</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-light-blue" href="tryit.asp?filename=tryw3css_theme_light-blue">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-cyan">w3-theme-cyan</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-cyan" href="tryit.asp?filename=tryw3css_theme_cyan">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-teal">w3-theme-teal</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-teal" href="tryit.asp?filename=tryw3css_theme_teal">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-green">w3-theme-green</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-green" href="tryit.asp?filename=tryw3css_theme_green">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-light-green">w3-theme-light-green</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-light-green" href="tryit.asp?filename=tryw3css_theme_light-green">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-lime">w3-theme-lime</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-lime" href="tryit.asp?filename=tryw3css_theme_lime">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-khaki">w3-theme-khaki</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-khaki" href="tryit.asp?filename=tryw3css_theme_khaki">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-yellow">w3-theme-yellow</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-yellow" href="tryit.asp?filename=tryw3css_theme_yellow">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-amber">w3-theme-amber</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-amber" href="tryit.asp?filename=tryw3css_theme_amber">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-orange">w3-theme-orange</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-orange" href="tryit.asp?filename=tryw3css_theme_orange">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-deep-orange">w3-theme-deep-orange</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-deep-orange" href="tryit.asp?filename=tryw3css_theme_deep-orange">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-blue-grey">w3-theme-blue-grey</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-blue-grey" href="tryit.asp?filename=tryw3css_theme_blue-grey">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-brown">w3-theme-brown</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-brown" href="tryit.asp?filename=tryw3css_theme_brown">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-grey">w3-theme-grey</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-grey" href="tryit.asp?filename=tryw3css_theme_grey">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-dark-grey">w3-theme-dark-grey</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-dark-grey" href="tryit.asp?filename=tryw3css_theme_dark-grey">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-black">w3-theme-black</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right w3-black" href="tryit.asp?filename=tryw3css_theme_black">Try it</a></td>
 </tr>
 <tr>
  <td class="w3-text-theme">w3-theme-w3schools</td>
  <td><a target="_blank" class="w3-btn w3-medium w3-right" href="tryit.asp?filename=tryw3css_theme_w3schools">Try it</a></td>
 </tr>
</table>
<hr>
...
<h2>Adding Gradients</h2>
<p>One reader sent us this suggestion: You might want to consider adding a gradient for each theme.</p>
<p>I used the l2 and l1 colors from the blue theme to create this gradient:</p>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 .w3-theme-gradient {<br>&nbsp; color: #000 !important;<br>&nbsp; 
 background:-webkit-linear-gradient(top,#64B5F6 25%,#42A5F5 75%)}<br>
 .w3-theme-gradient {<br>&nbsp; color: #000 !important;<br>&nbsp; background:-moz-linear-gradient(top,#64B5F6 
 25%,#42A5F5 75%)}<br>.w3-theme-gradient {<br>&nbsp; color: #000 !important;<br>&nbsp; 
 background:-o-linear-gradient(top,#64B5F6 25%,#42A5F5 75%)}<br>
 .w3-theme-gradient {<br>&nbsp; color: #000 !important;<br>&nbsp; background:-ms-linear-gradient(top,#64B5F6 
 25%,#42A5F5 75%)}<br>.w3-theme-gradient {<br>&nbsp; color: #000 !important;<br>&nbsp; 
 background: linear-gradient(top,#64B5F6 25%,#42A5F5 75%)}
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_theme_blue_gradient" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
<h2>Downloadable Color Themes</h2>
<p>Here are some downloadable color themes inspired by Google's Material Design:</p>
<table class="w3-table w3-bordered w3-striped w3-border">
 <tr>
  <th style="width:30%">Style Sheet</th>
  <th>Description</th>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-amber.css" target="_blank">w3-theme-amber.css</a></td>
  <td>Color Theme Amber</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-black.css" target="_blank">w3-theme-black.css</a></td>
  <td>Color Theme Black</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-blue.css" target="_blank">w3-theme-blue.css</a></td>
  <td>Color Theme Blue</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-blue-grey.css" target="_blank">w3-theme-blue-grey.css</a></td>
  <td>Color Theme Blue Grey</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-brown.css" target="_blank">w3-theme-brown.css</a></td>
  <td>Color Theme Brown</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-cyan.css" target="_blank">w3-theme-cyan.css</a></td>
  <td>Color Theme Cyan</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-dark-grey.css" target="_blank">w3-theme-dark-grey.css</a></td>
  <td>Color Theme Dark Grey</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-deep-orange.css" target="_blank">w3-theme-deep-orange.css</a></td>
  <td>Color Theme Deep Orange</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-deep-purple.css" target="_blank">w3-theme-deep-purple.css</a></td>
  <td>Color Theme Deep Purple</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-green.css" target="_blank">w3-theme-green.css</a></td>
  <td>Color Theme Green</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-grey.css" target="_blank">w3-theme-grey.css</a></td>
  <td>Color Theme Grey</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-indigo.css" target="_blank">w3-theme-indigo.css</a></td>
  <td>Color Theme Indigo</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-khaki.css" target="_blank">w3-theme-khaki.css</a></td>
  <td>Color Theme Khaki</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-light-blue.css" target="_blank">w3-theme-light-blue.css</a></td>
  <td>Color Theme Light Blue</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-light-green.css" target="_blank">w3-theme-light-green.css</a></td>
  <td>Color Theme Light Green</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-lime.css" target="_blank">w3-theme-lime.css</a></td>
  <td>Color Theme Lime</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-orange.css" target="_blank">w3-theme-orange.css</a></td>
  <td>Color Theme Orange</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-pink.css" target="_blank">w3-theme-pink.css</a></td>
  <td>Color Theme Pink</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-purple.css" target="_blank">w3-theme-purple.css</a></td>
  <td>Color Theme Purple</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-red.css" target="_blank">w3-theme-red.css</a></td>
  <td>Color Theme Red</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-teal.css" target="_blank">w3-theme-teal.css</a></td>
  <td>Color Theme Teal</td>
 </tr>
 <tr>
  <td><a href="/lib/w3-theme-yellow.css" target="_blank">w3-theme-yellow.css</a></td>
  <td>Color Theme Yellow</td>
 </tr>
</table>
<br>
<br>
