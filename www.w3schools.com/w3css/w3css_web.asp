...
<a class="w3-right w3-btn" href="w3css_web_html.asp">Next &#10095;</a>
</div>

<div class="w3-panel w3-info">
<h2>Web Building Crash Course</h2>
<p>Our Crash Course has only 5 pages:</p>
<ul>
<li><a href="w3css_web_html.asp">A HTML Skeleton</a></li>
<li><a href="w3css_web_css.asp">Using a Style Sheet</a></li>
<li><a href="w3css_web_javascript.asp">Using JavaScript</a></li>
<li><a href="w3css_web_layout.asp">Creating a Layout</a></li>
<li><a href="w3css_web_tmp_band.asp">Building a Web Site</a></li>
</ul>
</div>

<div class="w3-panel w3-info">
<h2>4 Web Building Secrets</h2>
<ul class="w3-ul">
<li>Always use the same HTML Skeleton</li>
<li>Always use the same Style Sheet</li>
<li>Always use the same JavaScript</li>
<li>Always use a Layout Plan</li>
</ul>
</div>

<h2>How to Create a Web Site</h2>
<p>This tutorial will teach you how to create a professional web site.</p>
<p>The intention is to teach you to code faster, easier, and more efficient.</p>
<p>Creating a web site is much easier than most people think.</p>
<p>The trick is to use the same frameworks and barebones in all your projects.</p>
<hr>
<h2>Commit Yourself</h2>
<p>Commit yourself to learn the basics of this tutorial in a few days.</p>
<p>Start Now! Do not waste any time! Do not install any software!</p>
<p>For a few days, commit yourself to:</p>
<ul>
  <li>Code everyday - Try all the examples in this tutorial.</li>
  <li>Code everyday - Do not waste time on any other subjects.</li>
  <li>Code everyday - Do not waste time on any other tutorials.</li>
</ul>
<p><a href="w3css_web_html.asp">Start Now !!</a></p>
