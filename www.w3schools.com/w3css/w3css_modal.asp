...
<h1>W3.CSS <span class="color_h1">Modal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_slideshow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_tooltips.asp">Next &#10095;</a>
</div>
<hr>
...
&lt;!-- Trigger/Open the Modal --&gt;<br>&lt;button onclick=&quot;document.getElementById('id01').style.display='block'&quot;<br>
class=&quot;w3-button&quot;&gt;Open Modal&lt;/button&gt;<br><br>&lt;!-- The Modal --&gt;<br>&lt;div 
id=&quot;id01&quot; class=&quot;w3-modal&quot;&gt;<br>&nbsp; 
&lt;div class=&quot;w3-modal-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
class=&quot;w3-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;span onclick=&quot;document.getElementById('id01').style.display='none'&quot;
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; class=&quot;w3-button w3-display-topright&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;p&gt;Some text in the Modal..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;p&gt;Some text in the Modal..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; 
&lt;/div&gt;<br>&lt;/div&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-panel w3-note">
  <p><strong>Tip:</strong> &amp;times; is the preferred HTML entity for close 
...
class="w3-button w3-dark-grey">Open Modal with Containers</button>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div id=&quot;id01&quot; class=&quot;w3-modal&quot;&gt;<br>&nbsp; &lt;div class=&quot;w3-modal-content&quot;&gt;<br>
  <br>&nbsp;&nbsp;&nbsp; &lt;header class=&quot;w3-container w3-teal&quot;&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;span onclick=&quot;document.getElementById('id01').style.display='none'&quot; 
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; class=&quot;w3-button w3-display-topright&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h2&gt;Modal Header&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/header&gt;<br>
  <br>&nbsp;&nbsp;&nbsp; &lt;div 
class=&quot;w3-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Some text..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;p&gt;Some text..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;footer class=&quot;w3-container 
w3-teal&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Modal Footer&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/footer&gt;<br>
  <br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal2" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
class="w3-button w3-dark-grey">Open Modal as a Card</button>
...
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
     &lt;div class=&quot;w3-modal-content w3-card-4&quot;&gt;<br></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal3" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<!-- Trigger the Modal -->
<button onclick="document.getElementById('zoom').style.display='block'"
class="w3-button w3-dark-grey">Zoom In</button>
<button onclick="document.getElementById('modtop').style.display='block'"
class="w3-button w3-dark-grey">Top</button>
<button onclick="document.getElementById('modbottom').style.display='block'"
class="w3-button w3-dark-grey">Bottom</button>
<button onclick="document.getElementById('modleft').style.display='block'"
class="w3-button w3-dark-grey">Left</button>
<button onclick="document.getElementById('modright').style.display='block'"
class="w3-button w3-dark-grey">Right</button>
<button onclick="document.getElementById('modfade').style.display='block'"
class="w3-button w3-dark-grey">Fade In</button>

<!-- The Modal -->
<div id="zoom" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('zoom').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<div id="modtop" class="w3-modal">
  <div class="w3-modal-content w3-animate-top w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('modtop').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<div id="modbottom" class="w3-modal">
  <div class="w3-modal-content w3-animate-bottom w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('modbottom').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<div id="modright" class="w3-modal">
  <div class="w3-modal-content w3-animate-right w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('modright').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<div id="modleft" class="w3-modal">
  <div class="w3-modal-content w3-animate-left w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('modleft').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<div id="modfade" class="w3-modal">
  <div class="w3-modal-content w3-animate-opacity w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('modfade').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<div id="modfade2" class="w3-modal w3-animate-opacity">
  <div class="w3-modal-content w3-card-4">
    <header class="w3-container w3-teal"> 
      <span onclick="document.getElementById('modfade2').style.display='none'" 
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2>Modal Header</h2>
    </header>
    <div class="w3-container">
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-modal-content w3-animate-zoom&quot;&gt;<br>&lt;div class=&quot;w3-modal-content w3-animate-top&quot;&gt;<br>
&lt;div class=&quot;w3-modal-content w3-animate-bottom&quot;&gt;<br>
&lt;div class=&quot;w3-modal-content w3-animate-left&quot;&gt;<br>
&lt;div class=&quot;w3-modal-content w3-animate-right&quot;&gt;<br>&lt;div class=&quot;w3-modal-content w3-animate-opacity&quot;&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal4" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<button onclick="document.getElementById('modfade2').style.display='block'"
class="w3-button w3-dark-grey">Fade in Modal</button>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-modal w3-animate-opacity&quot;&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_fade" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2>Modal Image</h2>
<p>Click on the image to display it as a modal, in full size:</p>
<img class="w3-hover-opacity" src="img_snowtops.jpg" alt="Norway"
onclick="document.getElementById('img01').style.display='block'"
...
<br>&lt;div id=&quot;modal01&quot; class=&quot;w3-modal w3-animate-zoom&quot; onclick=&quot;this.style.display='none'&quot;&gt;<br>&nbsp; 
&lt;img class=&quot;w3-modal-content&quot; src=&quot;img_snowtops.jpg&quot;&gt;<br>&lt;/div&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_image" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<div class="w3-row-padding" style="margin:0 -16px">
  <div class="w3-container w3-col s4 w3-margin-bottom">
    <img src="img_snowtops.jpg" style="width:100%;cursor:pointer" onclick="onClick(this)" class="w3-hover-opacity">
  </div>
  <div class="w3-container w3-col s4 w3-margin-bottom">
    <img src="img_lights.jpg" style="width:100%;cursor:pointer" onclick="onClick(this)" class="w3-hover-opacity">
  </div>
  <div class="w3-container w3-col s4 w3-margin-bottom">
    <img src="img_mountains.jpg" style="width:100%;cursor:pointer" onclick="onClick(this)" class="w3-hover-opacity">
  </div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;w3-row-padding&quot;&gt;<br>&nbsp; &lt;div class=&quot;w3-container w3-third&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
 &lt;img src=&quot;img_snowtops.jpg&quot; style=&quot;width:100%&quot; onclick=&quot;onClick(this)&quot;&gt;<br>&nbsp; 
 &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;w3-container w3-third&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img 
 src=&quot;img_lights.jpg&quot; style=&quot;width:100%&quot; onclick=&quot;onClick(this)&quot;&gt;<br>&nbsp; 
 &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;w3-container w3-third&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img 
 src=&quot;img_mountains.jpg&quot; style=&quot;width:100%&quot; onclick=&quot;onClick(this)&quot;&gt;<br>&nbsp; 
 &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div id=&quot;modal01&quot; class=&quot;w3-modal&quot; onclick=&quot;this.style.display='none'&quot;&gt;<br>&nbsp; 
 &lt;img class=&quot;w3-modal-content&quot; id=&quot;img01&quot; style=&quot;width:100%&quot;&gt;<br>&lt;/div&gt;<br><br>&lt;script&gt;<br>function 
 onClick(element) {<br>&nbsp; document.getElementById(&quot;img01&quot;).src = element.src;<br>&nbsp; 
 document.getElementById(&quot;modal01&quot;).style.display = &quot;block&quot;;<br>}<br>&lt;/script&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_gallery" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<div id="loginm" class="w3-modal">
  ...
  <div class="w3-center"><br>
    <span onclick="document.getElementById('loginm').style.display='none'" class="w3-button w3-hover-red w3-xxlarge w3-display-topright">&times;</span>
    ...
    <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
      <button onclick="document.getElementById('loginm').style.display='none'" type="button" class="w3-button w3-red">Cancel</button>
...
<a class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_login" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<div id="tabmodal" class="w3-modal">
 <div class="w3-modal-content w3-card-4 w3-animate-zoom">
  <header class="w3-container w3-blue"> 
   <span onclick="document.getElementById('tabmodal').style.display='none'" 
   class="w3-button w3-hover-red w3-xlarge w3-display-topright">&times;</span>
   <h2>Header</h2>
  </header>

  <div class="w3-bar w3-border-bottom">
    <a href="javascript:void(0)" class="tablinkmod w3-bar-item w3-button" onclick="openCity(event, 'Londontab')">London</a>
    <a href="javascript:void(0)" class="tablinkmod w3-bar-item w3-button" onclick="openCity(event, 'Paristab')">Paris</a>
    <a href="javascript:void(0)" class="tablinkmod w3-bar-item w3-button" onclick="openCity(event, 'Tokyotab')">Tokyo</a>
  </div>

  <div id="Londontab" class="w3-container city">
   <h1>London</h1>
  ...
  <div id="Paristab" class="w3-container city">
   <h1>Paris</h1>
   <p>Paris is the capital of France.</p>
   <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
  </div>

  <div id="Tokyotab" class="w3-container city">
   <h1>Tokyo</h1>
  ...
  <div class="w3-container w3-light-grey w3-padding">
   ...
   onclick="document.getElementById('tabmodal').style.display='none'">Close</button>
  </div>
 </div>
</div>
...
<a class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_tab" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
// Get the modal<br>var modal = document.getElementById('id01');<br><br>
// When the user clicks anywhere outside of the modal, close it<br>
window.onclick = function(event) {<br>&nbsp;&nbsp;if (event.target 
== modal) {<br>&nbsp;&nbsp;&nbsp; modal.style.display = &quot;none&quot;;<br>
&nbsp;&nbsp;}<br>}<br></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_close" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Advanced: Lightbox (Modal Image Gallery)</h2>
...
<div id="myModal" class="w3-modal w3-black">
 <span class="w3-text-white w3-xxlarge w3-hover-text-grey w3-container w3-display-topright cursor" title="Close Lightbox" onclick="closeModal()">&times;</span>
 <div class="w3-modal-content">
  ...
  <div class="w3-content" style="max-width:1200px">
   ...
   <div class="w3-row w3-black w3-center">
    ...
    <div class="w3-col s4">
     <img class="demo w3-opacity w3-hover-opacity-off cursor" src="img_nature_wide.jpg" style="width:100%" onclick="currentDiv(1)" alt="Nature and sunrise">
    </div>
    <div class="w3-col s4">
     <img class="demo w3-opacity w3-hover-opacity-off cursor" src="img_snow_wide.jpg" style="width:100%" onclick="currentDiv(2)" alt="French Alps">
    </div>
    <div class="w3-col s4">
     <img class="demo w3-opacity w3-hover-opacity-off cursor" src="img_mountains_wide.jpg" style="width:100%" onclick="currentDiv(3)" alt="Mountains and fjords">
    </div>
   </div> <!-- End row -->
  </div> <!-- End w3-content -->
...
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col s4">
    ...
    onclick="openModal();currentDiv(1)" class="w3-hover-shadow cursor">
  </div>
  <div class="w3-col s4">
    <img src="img_snow_wide.jpg" style="width:100%;cursor:pointer"
    onclick="openModal();currentDiv(2)" class="w3-hover-shadow cursor">
  </div>
  <div class="w3-col s4">
    <img src="img_mountains_wide.jpg" style="width:100%;cursor:pointer"
    onclick="openModal();currentDiv(3)" class="w3-hover-shadow cursor">
  </div>
</div>

</div>
<a class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=tryw3css_modal_lightbox" target="_blank">Try It Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> To learn more about slideshows, visit our <a href="w3css_slideshow.asp">W3.CSS Slideshow</a> chapter.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_slideshow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_tooltips.asp">Next &#10095;</a>
