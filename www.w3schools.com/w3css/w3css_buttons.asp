...
<h1>W3.CSS <span class="color_h1">Buttons</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_display.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_notes.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-bar">
  <button class="w3-bar-item w3-button w3-black">Button1</button>
  <button class="w3-bar-item w3-button w3-teal">Button2</button>
  <button class="w3-bar-item w3-button w3-dark-grey">Button3</button>
</div>
<div class="w3-section">
...
<p>The most common elements to use are 
...
<p><a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_all" target="_blank">Try It Yourself &raquo;</a></p>
</div>
<hr>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_colors" target="_blank">Try It Yourself &raquo;</a></p>
</div>
<hr>
...
<p>The <strong>w3-hover-<em>color</em></strong> classes is used to add 
hover color to buttons:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_hover_colors" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_buttons_shapes" target="_blank">
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_sizes" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_borders" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_text_effects3" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;button class=&quot;w3-button&quot;&gt;&lt;i&gt;Italic&lt;/i&gt;&lt;/button&gt;<br>
&lt;button class=&quot;w3-button&quot;&gt;&lt;b&gt;Bold&lt;/b&gt;&lt;/button&gt;<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_text_effects1" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;button class=&quot;w3-button w3-padding-small&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-button&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-button w3-padding-large&quot;&gt;Button&lt;/button&gt;<br><br>
&lt;button class=&quot;w3-btn w3-padding-small&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-btn&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-btn w3-padding-large&quot;&gt;Button&lt;/button&gt;
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_padding" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;button class=&quot;w3-button w3-block&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-button w3-block w3-teal&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-button w3-block w3-red w3-left-align&quot;&gt;Button&lt;/button&gt;<br><br>
&lt;button class=&quot;w3-btn w3-block&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-btn w3-block w3-teal&quot;&gt;Button&lt;/button&gt;<br>
&lt;button class=&quot;w3-btn w3-block w3-red w3-left-align&quot;&gt;Button&lt;/button&gt;
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_fullwidth" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel w3-note">
...
<p>The size of the a block can be defined using <strong>style="width:"</strong>.</p>
<p>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_width_size" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>Disabled buttons are opaque (semi-transparent) and display a "no parking sign":</p>
<p>
<button class="w3-button w3-teal">Button</button>
...
<p>The <strong>w3-disabled</strong> class is used to create a disabled button 
(if the element support the standard HTML disabled attribute, you can use the 
disabled attribute instead):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;a class="w3-button w3-disabled" href="https://www.w3schools.com"&gt;Link Button&lt;/a&gt;<br>
&lt;button class=&quot;w3-button&quot; disabled&gt;Button&lt;/button&gt;<br>
&lt;input type=&quot;button&quot; class=&quot;w3-button&quot; value=&quot;Button&quot; disabled&gt;<br><br>
&lt;a class="w3-btn w3-disabled" href="https://www.w3schools.com"&gt;Link Button&lt;/a&gt;<br>
&lt;button class=&quot;w3-btn&quot; disabled&gt;Button&lt;/button&gt;<br>
&lt;input type=&quot;button&quot; class=&quot;w3-btn&quot; value=&quot;Button&quot; disabled&gt;<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_disabled" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-bar&quot;&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-black&quot;&gt;Button&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-teal&quot;&gt;Button&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-red&quot;&gt;Button&lt;/button&gt;<br>
&lt;/div&gt;
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_bar" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel w3-note">
...
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-bar&quot;&gt;<br>
&nbsp; &lt;button class=&quot;w3-bar-item w3-button w3-black&quot;&gt;Button&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-bar-item w3-button w3-teal&quot;&gt;Button&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-bar-item w3-button w3-red&quot;&gt;Button&lt;/button&gt;<br>
&lt;/div&gt;
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_bar_item" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
...
&nbsp; &lt;button class=&quot;w3-button w3-black&quot;&gt;Button&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-teal&quot;&gt;Button&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-disabled&quot;&gt;Button&lt;/button&gt;<br>
&lt;/div&gt;<br>&lt;/div&gt;
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_bar_center" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
...
&nbsp; &lt;button class=&quot;w3-btn&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button 
class=&quot;w3-btn w3-teal&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;w3-btn 
w3-disabled&quot;&gt;Button&lt;/button&gt;<br>&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div 
  class=&quot;w3-show-inline-block&quot;&gt;<br>&lt;div 
class=&quot;w3-bar&quot;&gt;<br>
&nbsp; &lt;button class=&quot;w3-btn&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button 
class=&quot;w3-btn w3-teal&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;w3-btn 
w3-disabled&quot;&gt;Button&lt;/button&gt;<br>&lt;/div&gt;<br>&lt;/div&gt;<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_bar_inline" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<div class="w3-code notranslate htmlHigh">
  ...
  w3-button&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;w3-bar-item 
  w3-button&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;w3-bar-item 
  w3-button&quot;&gt;Button&lt;/button&gt;<br>&lt;/div&gt;</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_bar_nav" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-code notranslate htmlHigh">
  &lt;div 
class=&quot;w3-bar&quot;&gt;<br>&nbsp; &lt;button class=&quot;w3-bar-item w3-button&quot; 
style=&quot;width:33.3%&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;w3-bar-item w3-button 
w3-teal&quot; style=&quot;width:33.3%&quot;&gt;Button&lt;/button&gt;<br>&nbsp; &lt;button 
class=&quot;w3-bar-item w3-button w3-red&quot; style=&quot;width:33.3%&quot;&gt;Button&lt;/button&gt;<br>&lt;/div&gt;<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_bar_size" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-bar&quot;&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-left&quot;&gt;Left&lt;/button&gt;<br>
&nbsp; &lt;button class=&quot;w3-button w3-right&quot;&gt;Right&lt;/button&gt;<br>&lt;/div&gt;</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_leftright" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Buttons With Ripple Effects</h2>
<p>The <strong>w3-ripple</strong> class creates a ripple effect on buttons (when they are clicked on):</p>
<p>
...
class=&quot;w3-button w3-ripple w3-red&quot;&gt;Button&lt;/button&gt;<br>&lt;button class=&quot;w3-button 
w3-ripple w3-yellow&quot;&gt;Button&lt;/button&gt;<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_ripple" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_circle" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<p>Square buttons:</p>
<p>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_buttons_square" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
