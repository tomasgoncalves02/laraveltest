...
<h1>W3.CSS Margins</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_padding.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_display.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>W3.CSS Margin Classes</h2>
<p>W3.CSS provides the following margin classes:</p>
...
<h2>Margin</h2>
<p>The <strong>w3-margin</strong> class adds a 16px margin to all sides of an element:</p>
<div class="w3-border w3-section">
<div class="w3-container w3-margin w3-green">
  <p>The <strong>w3-margin</strong> class adds 16px margin to all sides of an 
  element.</p>
</div>
</div>
...
&nbsp; &lt;p&gt;I have 16px margin on all sides.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_margin" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-margin-top w3-green">
  <p>The <strong>w3-margin-top</strong> class adds a 16px <strong>top</strong> margin to an element.</p>
</div>
</div>
<div class="w3-example">
<h3>Example</h3>
...
&nbsp; &lt;p&gt;I have 16px margin on the top.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_margin_top" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<h2>Margin Bottom</h2>
<p>The <strong>w3-margin-bottom</strong> class adds a 16px bottom margin to an element:</p>
<div class="w3-border w3-section">
...
&nbsp; &lt;p&gt;I have 16px margin on the bottom.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_margin_bottom" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Margin Left</h2>
<p>The <strong>w3-margin-left</strong> class adds a 16px left margin to an element:</p>
<div class="w3-border w3-section">
...
&nbsp; &lt;p&gt;I have 16px margin the left.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_margin_left" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Margin Right</h2>
<p>The <strong>w3-margin-right</strong> class adds a 16px right margin to an element:</p>
<div class="w3-border w3-section">
...
&nbsp; &lt;p&gt;I have 16px margin the right.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_margin_right" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2>Sections</h2>
<p>Many HTML elements do not have a default top or bottom margin.
Such elements will display without a margin between them:</p>
...
<p>The <b>w3-section</b> class can be used to separate elements.</p>
<p>It adds
<strong>16px</strong> top and bottom margin to any HTML element:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-container w3-section w3-blue&quot;&gt;<br>&nbsp; &lt;h1&gt;I am 
 Blue&lt;/h1&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;w3-container 
  w3-section 
w3-green&quot;&gt;<br>&nbsp; &lt;h1&gt;I am Green&lt;/h1&gt;<br>&lt;/div&gt;
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_margin_sections" target="_blank">Try It Yourself &raquo;</a>
</div>
