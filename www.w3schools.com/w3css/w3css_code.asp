...
<h1>W3.CSS <span class="color_h1">Code</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_grid.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_filters.asp">Next &#10095;</a>
</div>
<hr>

<h2>Display Examples</h2>
<p>The <strong>w3-panel</strong> class is used to display examples in a grey container:</p>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_code_examples" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Display Code</h2>
<p>The <strong>w3-code</strong> class is used to display code in a readable mono-spaced font.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code">
fruits[0] = "Banana";<br>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_code" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Highlight Inline Code</h2>
<p>The <strong>w3-codespan</strong> class is used to highlight inline code:</p>
<p>The <code class="w3-codespan">html</code> element defines an HTML page.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  The
&lt;code class=&quot;w3-codespan&quot;&gt;html&lt;/code&gt; element defines an HTML page.</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_code_codespan" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<h2>Coloring Code</h2>
<p>W3Schools provides a JavaScript library for coloring code.</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>You can download the library from here: <span lang="no-bok">
<a target="_blank" href="https://www.w3schools.com/lib/w3codecolor.js">
https://www.w3schools.com/lib/w3codecolor.js</a></span></p>
<p>If you use the w3codecolor.js library, you can also use the code classes 
described below: </p>

<hr>
<h2>Highlight JavaScript Code</h2>
<p>The <strong>jsHigh</strong> class is used to highlight JavaScript code:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-code jsHigh&quot;&gt;<br><br>
.. JavaScript code here<br><br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_code_jshigh" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2>Highlight HTML Code</h2>
<p>The <strong>htmlHigh</strong> class is used to highlight HTML code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-code htmlHigh&quot;&gt;<br><br>
.. HTML code goes here<br><br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_code_htmlhigh" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2>Highlight CSS Code</h2>
<p>The <strong>cssHigh</strong> class is used to highlight CSS code:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;w3-code cssHigh&quot;&gt;<br><br>
.. CSS code here<br><br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_code_csshigh" target="_blank">Try It Yourself &raquo;</a>
</div>
