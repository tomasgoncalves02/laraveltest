...
<h1>W3.CSS Validation</h1>

<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="w3css_material.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="w3css_versions.asp">Next &#10095;</a>
</div>
<hr>
<h2>CSS Validation</h2>
<p>The W3C CSS Validation Service can be used to check the correctness (validity) of W3.CSS.</p>
<div class="w3-panel w3-note">
<p><a target="_blank" href="https://jigsaw.w3.org/css-validator/validator.html.en">The Validation Service</a> was created by the W3C to help Web developers
validate CSS.</p>
</div>
<hr>
<h2>Validation Warnings</h2>
<p>The W3C CSS Validator checks for CSS1, CSS2, CSS3, and CSS4 properties.<p>&nbsp;Some 
browsers use <strong>vendor extensions</strong> to simulate CSS3 and CSS4 
properties.</p>
<p>Vendor extensions can create warnings in the W3 CSS validation prosess.</p>
<hr>

<h2>Vendor Extensions</h2>
<p>W3.CSS uses <strong>vendor extensions</strong> to support older browsers.</p>
<p>Browser vendors are working to stop using prefixes in future browser 
versions.</p>
<p>Until then, some extensions will have to be used to make modern CSS work in 
all browsers.</p>
<p>Below is a list of the most common vendor extensions used:</p>
<table class="w3-table-all">
<tr><th>Extension</th><th>Browser</th></tr>
<tr><td>-webkit-</td><td>Chrome, Safari, Opera</td></tr>
<tr><td>-moz-</td><td>Firefox</td></tr>
<tr><td>-o-</td><td>Old Opera versions</td></tr>
<tr><td>-ms-</td><td>Microsoft Edge and Internet Explorer</td></tr>
</table>
