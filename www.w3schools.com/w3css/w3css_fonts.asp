...
<h1>W3.CSS <span class="color_h1">Fonts</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_defaults.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_fonts_google.asp">Next &#10095;</a>
</div>

<div class="w3-panel w3-info">
<p><b>Verdana</b> is the default font used in W3.CSS.
Verdana has a good letter spacing, and is easy to read. Verdana is also the default font for W3Schools.</p>
<p><b>Segoe UI</b> is the default font for headings.
Segoe UI has a more narrow letter spacing. This allows for a few more letters in the headings.</p>
</div>

<h2>Using Another Default Font</h2>
<p>Using another default font in W3.CSS is very easy:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
body, h1, h2, h3, h4, h5, h6 {<br>
&nbsp;&nbsp;font-family: Arial, Helvetica, Arial, sans-serif;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_arial" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Using Font Classes</h2>
<p>With W3.CSS you can use 4 different built-in font classes:</p>
<ul class="w3-ul">
<li>w3-serif</li>
<li>w3-sans-serif</li>
<li>w3-monospace</li>
...
<h2 class="w3-serif">This is w3-serif</h2>
<p class="w3-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large w3-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_sans-serif" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2 class="w3-sans-serif">This is w3-sans-serif</h2>
<p class="w3-sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large w3-sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<div class="w3-example">
<h3>Example</h3>
...
<h2 class="w3-monospace">This is w3-monospace</h2>
<p class="w3-monospace">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large w3-monospace">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_monospace" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2 class="w3-cursive">This is w3-cursive</h2>
<p class="w3-cursive">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large w3-cursive">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_cursive" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<tr><th>Font Family</th><th>Safe Fallback</th></tr>
<tr><td>Arial</td><td>Helvetica, sans-serif</td></tr>
<tr><td>Helvetica</td><td>Arial, sans-serif</td></tr>
<tr><td>Verdana</td><td>Geneva, sans-serif</td></tr>
<tr><td>Geneva</td><td>Verdana, sans-serif</td></tr>
<tr><td>Tahoma</td><td>Arial, sans-serif</td></tr>
<tr><td>Trebuchet MS</td><td>Arial, sans-serif</td></tr>
</table>
</div>

<p><b>Arial</b> is considered the safest sans-serif font on the web.
It is installed on all Windows machines (99.8%) and all Mac machines (98.7%).</p>
<p><b>Helvetica</b> is the preferred fallback because the two fonts are almost identical.
Helvetica runs on all Mac machines (100%) but on fewer Windows machines (7.3%).</p>
<p>Using Arial with Helvetica fallback, or Helvetiva with Arial fallback, covers both worlds.</p>
<p><b>Verdana</b> is also considered to be a web safe sans-serif font. It runs on all Windows machines
(99.8%), and all Mac Machines (99.1%).</p>
<p><b>Geneva</b> is Verdanas preferred fallback, because the two fonts are quite similar,
and Geneva runs on all Mac machines (99.6%).</p>
<p><b>Tahoma</b> was the standard font in Windows 95. It works on 99.9% of all Windows machines,
and 91.7% of all Mac machines.</p>
<p><b>Trebuchet MS</b> has been released with all Windows operating systems (99.7%) since Microsoft Windows 2000.
It is also included on Macs machines (97.1%), iOS and Chrome OS.</p>
<p>Source: <a target="_blank" href="https://www.cssfontstack.com">CSS Font Stack</a></p>
<hr>

<h2 style="font-family:Arial,Helvetica,sans-serif">This is Arial</h2>
<p style="font-family:Arial,Helvetica,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Arial,Helvetica,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<p>Arial is ranked <b>#1</b> in use on the Web.</p>
<hr>
<h2 style="font-family:Helvetica,Arial,sans-serif">This is Helvetica</h2>
<p style="font-family:Helvetica,Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Helvetica,Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_helvetica" target="_blank">Try It Yourself &raquo;</a>
</div>

<p>Helvetica is ranked <b>#2</b> in use on the Web.</p>
<hr>

<h2 style="font-family:Verdana,Geneva,sans-serif">This is Verdana</h2>
<p style="font-family:Verdana,Geneva,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Verdana,Geneva,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_verdana" target="_blank">Try It Yourself &raquo;</a>
</div>

<p>Verdana is ranked <b>#3</b> in use on the Web.</p>
<hr>

<h2 style="font-family:Geneva,Verdana,sans-serif">This is Geneva</h2>
<p style="font-family:Geneva,Verdana,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Geneva,Verdana,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<div class="w3-code notranslate cssHigh">
body, h1, h2, h3, h4, h5, h6 {<br>
&nbsp;&nbsp;font-family: Geneva, Verdana, sans-serif;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_geneva" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2 style="font-family:Tahoma,Arial,sans-serif">This is Tahoma</h2>
<p style="font-family:Tahoma,Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Tahoma,Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<div class="w3-code notranslate cssHigh">
body, h1, h2, h3, h4, h5, h6 {<br>
&nbsp;&nbsp;font-family: Tahoma, "Trebuchet MS", sans-serif;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_tahoma" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2 style="font-family:'Trebuchet MS',Arial,sans-serif">This is Trebuchet MS</h2>
<p style="font-family:'Trebuchet MS',Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:'Trebuchet MS',Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_trebuchet" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>
<h2 style="font-family:'Segoe UI'Arial,sans-serif">This is Segoe UI</h2>
<p style="font-family:'Segoe UI'Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large"style="font-family:'Segoe UI'Arial,sans-serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_segoe_ui" target="_blank">Try It Yourself &raquo;</a>
</div>
<p>Segoe UI is the default font in Windows 10. It is also the default heading font in W3Schools an W3.CSS.</p>
<hr>
...
<table class="w3-table-all">
<tr><th>Font Family</th><th>Safe Fallback</th></tr>
<tr><td>Times New Roman</td><td>Times, serif</td></tr>
<tr><td>Georgia</td><td>serif</td></tr>
</table>
</div>

<p><b>Times New Roman</b> is considered the most web safe serif font.
It works on all Windows machines (99.7%) and all Mac machines (97.4%).</p>
<p>Some older operating systems might have an alternative version called <b>Times</b>,
so it is smart to use Times as a fallback as well as serif.</p>
<p><b>Georgia</b> is also considered very safe. It is a little larger than Times New Roman,
but works well on most Windows machines (99.4%) and Mac machines (97.5%).</p>
<p>To be on the safe side, use serif as fallback.</p>

<hr>
<h2 style="font-family:Times New Roman,Times,serif">This is Times New Roman</h2>
<p style="font-family:Times New Roman,Times,serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Times New Roman,Times,serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_times" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2 style="font-family:Georgia,serif">This is Georgia</h2>
<p style="font-family:Georgia,serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:Georgia,serif">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_georgia" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<div>
<h2>Monospace Fonts</h2>
<p>In a monospace font, all letters occupy the same width.</p>
<p>Monospaced fonts are often used to display computer code.</p>
<div class="w3-container w3-info">
<table class="w3-table-all">
<tr><th>Font Family</th><th>Safe Fallback</th></tr>
<tr><td>Curier New</td><td>monospace</td></tr>
<tr><td>Lucida Console</td><td>Monaco, monospace</td></tr>
<tr><td>Monaco</td><td>Lucida Console, monospace</td></tr>
</table>
</div>
<div>
<p><b>Courier New</b> is considered the most web safe monospace font.
It is installed on most Windows and Mac machines.</p>
<p><b>Lucida Console</b> does not run on Mac. <b>Monaco</b> does not run on Windows.</p>
<p>One solution is to use Monaco as fallback for Lucida Console.</p>
</div>
<p>There are no 100% web safe fonts, but you can always use <b>w3-monospace</b>.</p>
<hr>
...
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-monospace w3-large">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<hr>
<h2 style="font-family:'Courier New',monospace">This is Courier New</h2>
<p style="font-family:'Courier New',monospace">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p  class="w3-large" style="font-family:'Courier New',monospace">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_courier" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
<h2 style="font-family:'Lucida Console',Monaco,monospace">This is Lucida or Monaco</h2>
<p style="font-family:'Lucida Console',Monaco,monospace">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-large" style="font-family:'Lucida Console',Monaco,monospace">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_monaco" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>


<h1 class="w3-cursive">Handwriting Fonts</h1>
<p class="w3-cursive">There are no web safe handwriting fonts, but you can safely use <b>w3-cursive</b>.</p>

<h2 class="w3-cursive">This is w3-cursive</h2>
<p  class="w3-cursive">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<p class="w3-cursive w3-large">Norway has a total area of 385,252 square kilometers and a population of 5,438,657 (December 2020).
Norway is bordered by Sweden, Finland and Russia to the north-east,
and the Skagerrak to the south, with Denmark on the other side.</p>
<div class="w3-example">
<h3>Example</h3>
