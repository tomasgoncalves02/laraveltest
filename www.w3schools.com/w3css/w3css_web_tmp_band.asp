...
<a class="w3-left w3-btn" href="w3css_web_layout.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_web_tmp_catering.asp">Next &#10095;</a>
</div>
<div class="w3-panel w3-light-grey">
<h2>HowTo Create a Web Page</h2>
...
<p>Use the skeleton from the previous chapter.</p>
<p>A simple skeleton with only one picture:</p>
</div>
...
&lt;title&gt;The Band&lt;/title&gt;<br>
&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width,initial-scale=1&quot;&gt;<br>
&lt;link rel=&quot;stylesheet&quot; href=&quot;https://www.w3schools.com/w3css/4/w3.css&quot;&gt;<br>
&lt;script src="https://www.w3schools.com/lib/w3.js"&gt;&lt;/script&gt;<br>
&lt;body&gt;<br><br>
  &lt;!-- Start Content --&gt;<br>&lt;div id="home" class="w3-content"&gt;<br>
<br>
&lt;!-- Image --&gt;<br>
&lt;img src=&quot;img_la.jpg&quot; alt="The Band" style=&quot;width:100%&quot;&gt;<br><br>
  &lt;!-- End Content --&gt;<br>&lt;/div&gt;<br>
  <br>&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<p><a href="tryit.asp?filename=tryweb_band" target="_blank"
...
<p>Add a navigation bar for navigating to Home, About, Members and Contact.</p>
</div>
<div class="w3-bar w3-black">
<a class="w3-bar-item w3-button">Home</a>
<a class="w3-bar-item w3-button">About</a>
<a class="w3-bar-item w3-button">Members</a>
<a class="w3-bar-item w3-button">Contact</a>
</div>
<img src="img_la.jpg" alt="The Band" style="width:100%">
...
&lt;!-- Navigation (Stays on Top) --&gt;<br>
&lt;div class="w3-top w3-bar w3-black"&gt;<br>
&lt;a href="#home" class="w3-bar-item w3-button"&gt;Home&lt;/a&gt;<br>
&lt;a href="#about" class="w3-bar-item w3-button"&gt;About&lt;/a&gt;<br>
&lt;a href="#members" class="w3-bar-item w3-button"&gt;Members&lt;/a&gt;<br>
&lt;a href="#contact" class="w3-bar-item w3-button"&gt;Contact&lt;/a&gt;<br>
  &lt;/div&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryweb_band_navigation" class="w3-btn w3-margin-bottom">
Try it Yourself »</a>
</div>
<hr>
...
<hr>
<div class="w3-panel w3-light-grey">
<h2>Add Slide Show</h2>
<p>Change the image to a side show.</p>
</div>
...
<div class="w3-code notranslate htmlHigh">
&lt;!-- Slides --&gt;<br>
&lt;img class="slides" src="img_la.jpg" width="100%"&gt;<br>
&lt;img class="slides" src="img_ny.jpg" width="100%"&gt;<br>
&lt;img class="slides" src="img_ch.jpg" width="100%"&gt;<br>
&lt;script&gt;<br>
w3.slideshow(".slides", 1500);<br>
&lt;/script&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryweb_band_slides" class="w3-btn w3-margin-bottom">
Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-light-grey">
<h2>Add About</h2>
<p>Add some information about the band</p>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- About --&gt;<br>&lt;div id="about" class="w3-container w3-padding-32"&gt;<br>&lt;h1 
  class="w3-center"&gt;The Band&lt;/h1&gt;<br>&lt;p&gt;This is our band website. Lorem ipsum 
  dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt 
  ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
  exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.&lt;/p&gt;<br>
  &lt;/div&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryweb_band_about" class="w3-btn w3-margin-bottom">
Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-light-grey">
<h2>Add Band Members</h2>
<p>Add a picture of each band member</p>
</div>
<div id="members" class="w3-container w3-padding-32">
<h2 class="w3-center">Band Members</h2>
<div class="w3-row w3-center">
<div class="w3-third">
  <img src="img_bandmember.jpg" alt="Name1" style="width:60%"><br>John<br>
</div>
<div class="w3-third">
  <img src="img_bandmember.jpg" alt="Name2" style="width:60%"><br>Paul<br>
</div>
<div class="w3-third">
  <img src="img_bandmember.jpg" alt="Name3" style="width:60%"><br>Lisa<br>
</div>
</div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- Members --&gt;<br>&lt;div id="members" class="w3-container w3-padding-32"&gt;<br>&lt;div class="w3-row w3-center"&gt;<br>
  <br>&lt;div class="w3-third"&gt;<br>
  &lt;img src="img_bandmember.jpg" alt="Name1" style="width:60%"&gt;<br>
  &lt;/div&gt;<br>
  <br>&lt;div class="w3-third"&gt;<br>
  &lt;img src="img_bandmember.jpg" alt="Name2" style="width:60%"&gt;<br>
  &lt;/div&gt;<br><br>&lt;div class="w3-third"&gt;<br>
  &lt;img src="img_bandmember.jpg" alt="Name3" style="width:60%"&gt;<br>
  &lt;/div&gt;<br>
  <br>&lt;/div&gt;
<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryweb_band_members" class="w3-btn w3-margin-bottom">
Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-light-grey">
<h2>Add Contact Info</h2>
<p>Add contact info and a contact form.</p>
</div>
<div class="w3-center">
<h2 class="w3-wide">CONTACT</h2>
Chicago, US<br>Phone: +00 151515<br>Email: mail@mail.com<br>
...
<p class="w3-padding">Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank">w3.css</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div id="contact" class="w3-container w3-center w3-padding-32"&gt;<br>&lt;h2 
  class="w3-wide"&gt;CONTACT&lt;/h2&gt;<br>Chicago, US&lt;br&gt;<br>Phone: +00 151515&lt;br&gt;<br>
  Email: mail@mail.com&lt;br&gt;<br>&lt;p class="w3-opacity w3-center"&gt;&lt;i&gt;Fan? Drop a 
  note!&lt;/i&gt;&lt;/p&gt;<br><br>&lt;form action="/action_page.php" target="_blank"&gt;<br>
  &lt;input class="w3-input" type="text" placeholder="Name" required name="Name"&gt;<br>
  &lt;input class="w3-input" type="text" placeholder="Email" required name="Email"&gt;<br>
  &lt;input class="w3-input" type="text" placeholder="Message" required 
  name="Message"&gt;<br>&lt;br&gt;<br>&lt;button class="w3-button w3-black" 
  type="submit"&gt;SEND&lt;/button&gt;<br>&lt;/form&gt;<br><br>&lt;img src="map.jpg" 
  class="w3-image" style="width:100%"&gt; <br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryweb_band_contact" class="w3-btn w3-margin-bottom">
Try it Yourself &raquo;</a>
<a target="_blank" href="tryit.asp?filename=tryweb_band_full" class="w3-btn w3-margin-bottom">
Try All &raquo;</a>
</div>
