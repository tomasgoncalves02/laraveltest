...
<h1>W3.CSS <span class="color_h1">Demos</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_templates.asp">Next &#10095;</a>
</div>
...
<div class="w3-row-padding" style="margin:16px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Photo Album</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_album.htm" target="_blank"><img alt="Demo Web Album" class="w3-border" src="img_photo_album2.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_album.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_album" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Photo Album II</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_album_text.htm" target="_blank"><img class="w3-border" src="img_photo_album.jpg" style="width:98%;margin:20px 0" alt="Demo Photo Album 2"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_album_text.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_album_text" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Newspaper</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_newspaper.htm" target="_blank"><img alt="Demo Newspaper" class="w3-border" src="img_demo_news.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_newspaper.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_newspaper&stacked=h" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Newspaper (More Space)</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_newspaper_space.htm" target="_blank"><img alt="Demo Magazine" class="w3-border" src="img_demo_news2.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_newspaper_space.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_newspaper_space&stacked=h" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      ...
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_blog.htm" target="_blank"><img alt="Demo Newspaper" class="w3-border" src="img_demo_blog.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_blog.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_blog&stacked=h" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Magazine</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_magazine.htm" target="_blank"><img alt="Demo Magazine" class="w3-border" src="img_demo_magazine.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_magazine.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_magazine&stacked=h" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Material Design</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_material.htm" target="_blank"><img alt="Demo Material" class="w3-border" src="img_demo_material.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_material.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_material" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Mail</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_mail.htm" target="_blank"><img class="w3-border" alt="Demo Mail" src="img_demo_mail.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_mail.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_mail" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Modal Login</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_modal_login.htm" target="_blank"><img alt="Demo Modal Login" class="w3-border" src="img_demo_modal_login.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_modal_login.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_modal_login" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Login Form</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_login.htm" target="_blank"><img class="w3-border" alt="Login Form" src="img_demo_login.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_login.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_login" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Form Using Icons</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_contact.htm" target="_blank"><img alt="Demo Modal Login" class="w3-border" src="img_demo_contact.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_contact.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_contact" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Form Using Icons</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_widget.htm" target="_blank"><img alt="Demo Modal Login" class="w3-border" src="img_demo_widget.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_widget.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_widget" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">ADS</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_ads.htm" target="_blank"><img alt="Demo ADS" class="w3-border" src="img_demo_ads.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_ads.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_ads" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">ADS II</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_ads2.htm" target="_blank"><img class="w3-border" alt="Demo ADS 2" src="img_demo_ads2.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_ads2.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_ads2" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Wine Album</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_chardonney.htm" target="_blank"><img alt="Demo Wine Album" class="w3-border" src="img_demo_wine.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_chardonney.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_chardonney" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Pricing Table</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_pricing_tables.htm" target="_blank"><img class="w3-border" alt="Demo Pricing Table" src="img_demo_pricing.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_pricing_tables.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_pricing_tables" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-row-padding" style="margin:32px -16px">
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Homepage</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_home.htm" target="_blank"><img alt="Demo Homepage" class="w3-border" src="img_demo_homepage.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_home.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_home" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3-col m6">
    <div class="w3-container w3-padding-16 w3-card">
      <h3 class="w3-center">Homepage II</h3>
      <div class="w3-content" style="max-width:550px">
        <a href="tryw3css_examples_home2.htm" target="_blank"><img class="w3-border" alt="Demo Homepage 2" src="img_demo_homepage2.jpg" style="width:98%;margin:20px 0"></a></div>
      <div class="w3-row">
        <div class="w3-col m6">
          <a href="tryw3css_examples_home2.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98%">Demo</a>
        </div>
        <div class="w3-col m6">
          <a href="tryit.asp?filename=tryw3css_examples_home2" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:100%">Try it &raquo;</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-container w3-light-grey w3-padding-16 w3-card">
<h3 class="w3-center">Advertising Example</h3>
<div class="w3-content" style="max-width:800px">
<a href="tryw3css_examples_ads3.htm" target="_blank">
<img src="img_deadline.jpg" style="width:98%;margin:20px 0" alt="Advertisement"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="tryw3css_examples_ads3.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryw3css_examples_ads3" target="_blank" class="w3-btn w3-padding-large w3-dark-grey" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
...
<header class="w3-bar w3-green w3-card-4">
  <button class="w3-bar-item w3-button" onclick="w3_openSidebar()" style="font-size:50px">&#9776;</button>
  <h1 class="w3-bar-item">Movies 2014</h1>
</header>
...
<footer class="w3-container" style="background-color:#93cf95;position:relative">
  <a class="w3-button w3-xlarge w3-circle w3-green" style="background-color:#265728;position:absolute;top:-28px;right:16px;">+</a>
  <p>Copyright 2016</p>
</footer>
<div class="w3-container w3-xlarge" style="background-color:#265728;color:white">&laquo;<span class="w3-right">&raquo;</span></div>

</div>
</div>
<div class="w3-half w3-large">
<a href="tryw3css_examples_mobile_blue.htm" target="_blank" class="w3-button w3-blue">Demo</a>
<a href="tryit.asp?filename=tryw3css_examples_mobile_blue" target="_blank" class="w3-button w3-blue">Try it Yourself &raquo;</a><br><br>
<a href="tryw3css_examples_mobile_teal.htm" target="_blank" class="w3-button w3-teal">Demo</a>
<a href="tryit.asp?filename=tryw3css_examples_mobile_teal" target="_blank" class="w3-button w3-teal">Try it Yourself &raquo;</a><br><br>
<a href="tryw3css_examples_mobile_red.htm" target="_blank" class="w3-button w3-red">Demo</a>
<a href="tryit.asp?filename=tryw3css_examples_mobile_red" target="_blank" class="w3-button w3-red">Try it Yourself &raquo;</a><br><br>
<a href="tryw3css_examples_mobile_green.htm" target="_blank" class="w3-button w3-green">Demo</a>
<a href="tryit.asp?filename=tryw3css_examples_mobile_green" target="_blank" class="w3-button w3-green">Try it Yourself &raquo;</a><br><br>
<a href="tryw3css_examples_mobile_black.htm" target="_blank" class="w3-button w3-black">Demo</a>
<a href="tryit.asp?filename=tryw3css_examples_mobile_black" target="_blank" class="w3-button w3-black">Try it Yourself &raquo;</a><br><br>
<a href="tryw3css_examples_mobile_amber.htm" target="_blank" class="w3-button w3-amber">Demo</a>
<a href="tryit.asp?filename=tryw3css_examples_mobile_amber" target="_blank" class="w3-button w3-amber">Try it Yourself &raquo;</a><br><br>
