...
<h1>W3.CSS <span class="color_h1">Trends</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_filters.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_case.asp">Next &#10095;</a>
</div>

<hr>

<div class="w3-dark-grey w3-center" style="padding:32px">
  <div class="w3-xxlarge w3-text-white w3-padding-32" style="background-color:#B93A32">WEBDESIGN</div>
  <br>
  <div class="w3-row">
    <div class="w3-xlarge w3-half sw3-serif" style="background-color:#034F84">trends</div>
    <div class="w3-xxxlarge w3-half" style="background-color:#91A8D0">2017</div>
  </div>
</div>

<p>Every year you will see new web techniques and trends.</p>
<p>On this page we will bring you some of the most relevant web design trends.</p>

<hr>
<h2>Flat Design</h2>
<p>The flat design trend started with Windows Phone 7 and Windows 8 in 2010:</p>
<img src="img_flat_windows.jpg" alt="Windows Tiles" style="width:100%;xmax-width:700px">

<p>It was followed up by Apple with iOS 7 in 2013:</p>
<img src="img_flat_iphone.jpg" alt="Iphone Icons" style="width:100%;xmax-width:700px">
...
<a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_colors" target="_blank">Try It Yourself &raquo;</a>

<div class="w3-panel w3-note w3-margin-top">
  <p>One big problem with flat design is to understand which areas are clickable.<br>What is the difference between an image and a clickable button?</p>
</div>

<hr>
<h2>Almost Flat Design (Flat 2.0)</h2>

<p>Almost flat is a newer alternative to the original flat design.</p>
<p>Almost flat acquires more depth, brighter colors, complex shadows, and dimension.</p>

<div class="w3-section">
<h3>Shadows:</h3>
<div class="w3-bar w3-black w3-card-4">
  <span class="w3-bar-item w3-hover-red w3-padding-16">Home</span>
  <span class="w3-bar-item w3-hover-red w3-padding-16">Link 1</span>
  <span class="w3-bar-item w3-hover-red w3-padding-16">Link 2</span>
  <span class="w3-bar-item w3-hover-red w3-padding-16 w3-right"><i class="fa fa-search w3-large"></i></span>
</div>
</div>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_shadows" target="_blank">Try It Yourself &raquo;</a>
<hr>
...
<p>Since we might have reached the peak of flat design (with almost flat), many 
designers are expected to go for Material Design (Designed by Google in 2014).</p>

<p>Material Design uses elements that remind us of paper and ink. In addition 
the elements have realistic shadows 
and hover effects.</p>
<div class="w3-display-container">
<img src="img_material.png" alt="Material" style="width:100%">
<p class="w3-display-bottomleft w3-container">
<a href="https://www.google.com/design/spec/material-design/introduction.html" target="_blank">Google Material Design</a></p>
</div>
<p><a class="w3-btn" href="tryit.asp?filename=tryw3css_examples_material" target="_blank">Try It Yourself &raquo;</a></p>

<hr>
<h2>Cards</h2>

<p>Most typical cards are rectangles with an image and some text.</p>

<p>Cards have become a common structure for organizing headlines, images, and text on an equal plane.</p>
<p>Cards can be small or large, with or without pictures, and with or without shadows:</p>
<div class="w3-row-padding w3-margin-top" style="margin:0 -16px">

<div class="w3-half">
<div class="w3-card-4">
  <img src="img_avatar3.png" alt="Avatar" style="width:100%;opacity:0.75">
...
<a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_cards" target="_blank">Try It Yourself &raquo;</a>
</div>
</div>
...
<div class="w3-card-4">
  ...
  <div class="w3-container">
    ...
    <div class="w3-button w3-dark-grey w3-block">+</div>
</div>
<br>
<div class="w3-card-4">
  ...
  <div class="w3-container w3-center">
    <p>Cinque Terre. Liguria. Itali.</p>
  </div>
</div>
</div>
</div>
...
<hr>
<h2>Cleaner Logos</h2>
<p>Cleaner logos is a result of the popularity of flat design:</p>
<div class="w3-row" style="margin:0 -16px">
<div class="w3-half">
<img src="img_google_serif.png" alt="Google" style="width:100%">
</div>
<div class="w3-half">
<img src="img_google_flat.png" alt="Google" style="width:100%">
</div>
</div>

<hr>
<h2>Minimalism</h2>
<p>Easy to read. Easy to understand. Easy to design.</p>
<div class="w3-dark-grey w3-padding-64"><h1 class="w3-center">Our Customers</h1></div>
<div class="w3-bar w3-black">
  <a class="w3-bar-item w3-button w3-hover-green w3-padding-16" href="javascript:void(0)">Home</a>
  <a class="w3-bar-item w3-button w3-hover-green w3-padding-16" href="javascript:void(0)">Link 1</a>
  <a class="w3-bar-item w3-button w3-hover-green w3-padding-16" href="javascript:void(0)">Link 2</a>
  <a class="w3-bar-item w3-button w3-right w3-hover-green w3-padding-16" href="javascript:void(0)">
  <i class="fa fa-search w3-large"></i></a>
</div>
<div style="background:#8FBC8F" class="w3-padding-64">
<h1 class="w3-center">WE WILL ADD REAL VALUE<br>TO OUR CLIENTS BUSINESS</h1></div>
<div class="w3-dark-grey w3-padding-64"><h1 class="w3-center">We know how to make our clients happy</h1></div>

<p>Minimalism can go hand in hand with Almost Flat Design:</p>

<div class="w3-padding-32 w3-center w3-blue-grey">
  <h1>About Me</h1>
  <img src="img_avatar3.png" class="w3-margin w3-circle w3-card-4" alt="Person" style="width:50%">
  <div class="w3-padding-large">
    <p>The term minimalist often refers to anything that is spare or stripped to its essentials.</p>
    <p>Design minimalism can help simplify and improve designs as well.</p>
  </div>
</div>

<hr>
<h2>Readable Typography</h2>
<p>The natural typography of flat design is simple and easy to read.</p>
<p>Letter-spacing and line-spacing is typically larger.</p>
<p>Also expect increased font sizes in order to focus more on reader's attention.</p>

<div class="w3-panel w3-border" style="font-family:'Times New Roman', Times, serif">
<h3>Standard Serif</h3>
<p>
...
<div class="w3-panel w3-border" style="font-family:Arial, Helvetica, sans-serif">
<h3>Standard Sans Serif</h3>
<p>
Simplicity and readability is the most important reason for flat design.
Simplicity and readability is the most important reason for flat design.
Simplicity and readability is the most important reason for flat design.
...
<div class="w3-panel w3-note">
  <p>Readability is an important reason for the popularity of flat typography.</p>
</div>

<p><a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_serif" target="_blank">Try It Yourself &raquo;</a></p>

<hr>
<h2>Full Screen Input</h2>
<p>More and more sites are using full screen for inputs like signups and logins, instead of 
using only a small part of the page.</p>
<p>Full screen often uses a screen overlay or modal instead of redirecting to a new page.</p>
<div class="w3-card-4 w3-pale-yellow">
<div>
<span class="w3-btn w3-right w3-black w3-hover-red">X</span>
</div>
<br>
<div class="w3-panel"> 
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_full_input" target="_blank">Try It Yourself &raquo;</a>
</p>

<hr>
<h2>Mobile First</h2>
<p>Historically, web designers have developed web applications for computers 
first, and then added responsive web design to make sure 
the web looks good when viewed on a tablet or a phone.</p>
<p>This trend is shifting towards designing for mobiles first, and then add 
responsive design to make a site work on desktops and laptops.</p>

<p>50/50 is an easy way to achieve web design for responsive webs. With 50/50 design,
the screen can show two pages on large screens and one page on narrow screens.</p>
  ...
  <div class="w3-half w3-teal w3-container" style="height:600px">
    <div class="w3-padding-64 w3-padding-large w3-center">
      ...
      <form class="w3-container w3-card w3-padding-32 w3-white">
        ...
        <button type="button" class="w3-btn w3-black">Send</button>
      </form>
    </div>
  </div>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_50" target="_blank">Try It Yourself &raquo;</a>
</p>

<hr>
<h2>Large Hero Images</h2>

<p>"Hero image" is a term used for a specific type of web banner.</p>
<p>A hero image is a large image, placed in the front of a web page. It often consists of 
both an image and some text, and it can be static or a rotating list of images.</p>
<p>The purpose of an hero image is to present the web site's most important content.</p>
...
<div class="w3-display-container w3-animate-opacity">
  ...
  <div class="w3-container w3-display-bottomright w3-text-white w3-large"><p>Brought to you by Captain Hook</p></div>
</div>
<div class="w3-container w3-border">
<h2>Welcome to my Sailing Web</h2>
...
with respect to the true wind. (Wikipedia)
</p>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_large_hero" target="_blank">Try It Yourself &raquo;</a>
</p>
...
<p>The web design trend shifts from regular clicking to vertical scrolling.</p>
<p>Scrolling allows users to see all the web content on the one page.</p>
<p>This single page technique has been used by social networks a long time, until somebody 
discovered that it suits other pages as well.</p>

<div style="height:350px;overflow:hidden;">
<iframe src="tryw3css_trends_single.htm" height="350px" style="width:100%"></iframe>
</div>

<p><a class="w3-btn" href="tryit.asp?filename=tryw3css_trends_single" target="_blank">Try It Yourself &raquo;</a></p>
