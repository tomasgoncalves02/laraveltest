...
<h1>W3.CSS <span class="color_h1">Alerts</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_quotes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_tables.asp">Next &#10095;</a>
</div>

<hr>
<p>The <strong>w3-panel</strong> class is the perfect class to display all types of alerts:</p>
...
&nbsp; &lt;h3&gt;Danger!&lt;/h3&gt;<br>
&nbsp; &lt;p&gt;Red often indicates a dangerous or negative situation.&lt;/p&gt;<br>
&lt;/div&gt;&nbsp;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts" target="_blank">Try It Yourself &raquo;</a>
</div>
...
&nbsp; &lt;h3&gt;Success!&lt;/h3&gt;<br>&nbsp; &lt;p&gt;Green often indicates something successful 
  or positive.&lt;/p&gt;<br>&lt;/div&gt;&nbsp;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_success" target="_blank">Try It Yourself &raquo;</a>
</div>
...
&nbsp; &lt;h3&gt;Information!&lt;/h3&gt;<br>&nbsp; &lt;p&gt;Blue often indicates a neutral 
  informative change or action.&lt;/p&gt;<br>
&lt;/div&gt;&nbsp;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_info" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<p>The <strong>w3-container </strong>class 
can also be used to display alerts:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_containers" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<h2>Alerts in All Colors</h2>
<p>Alerts are often displayed in special colors, but any color can be used:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_colors" target="_blank">Try It Yourself &raquo;</a>
</div>

<hr>

<h2>Closing Alerts</h2>
<p>To close the alert box, click on the X in the upper right corner:</p>
<div class="w3-panel w3-red w3-display-container">
    <span onclick="this.parentElement.style.display='none'" class="w3-button w3-large w3-red w3-display-topright">&times;</span>
    <h3>Danger!</h3>
    <p>Red often indicates a dangerous or negative situation.</p>
</div>
<p>To create the X that closes the alert, add a &lt;span&gt; element with class
<strong>w3-button</strong> and an <strong>onclick</strong> event:</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
   &lt;span onclick=&quot;this.parentElement.style.display='none'&quot;<br>class=&quot;w3-button 
   w3-display-topright&quot;&gt;&amp;times;&lt;/span&gt; </div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_close" target="_blank">Try It Yourself &raquo;</a>
</div>
<div class="w3-panel w3-note">
  <p><strong>Tip:</strong> The HTML <strong>&amp;times;</strong> entity is the preferred icon for close buttons 
...
<h3>Example</h3>
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_round" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Alert as a Card</h2>
<p>Use a <strong>w3-card</strong> class if you want the alert to be displayed as a card:</p>
<div class="w3-panel w3-yellow w3-card-4">
<h3>Warning!</h3>
<p>Yellow often indicates something that needs attention.</p>
</div>
...
<h3>Example</h3>
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_card" target="_blank">Try It Yourself &raquo;</a>
</div>
