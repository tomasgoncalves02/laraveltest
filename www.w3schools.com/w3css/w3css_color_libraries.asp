...
<html lang="en-US">
<head>
<title>W3.CSS Color Libraries</title>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/lib/w3-colors-highway.css">
...
<link rel="stylesheet" href="/lib/w3-colors-food.css">
<link rel="stylesheet" href="/lib/w3-colors-vivid.css">
<link rel="stylesheet" href="/lib/w3-colors-windows.css">
</head>
<body>
...
<h1>W3.CSS <span class="color_h1">Color Libraries</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_color_fashion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_color_schemes.asp">Next &#10095;</a>
</div>

<hr>
<h2>Color Libraries</h2>
<p>Color libraries are small CSS files containing commonly used color values 
like safety standards, highway colors, fashion colors, camouflage colors, and 
more.</p>

<p>
<div class="w3-tag w3-highway-schoolbus w3-xlarge w3-card">Schoolbus</div>
<div class="w3-tag w3-highway-green w3-xlarge">Falcon Ridge Parkway</div>
<div class="w3-tag w3-highway-red w3-xlarge">STOP</div></p> 

<hr>
<h2>How to Use Color Libraries</h2>

<p>Color libraries are easy to use. Just add a link to the color library in your 
web page: </p>
...
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;div class="w3-highway-schoolbus"&gt;Schoolbus&lt;/div&gt;<br>&lt;div 
  class="w3-highway-green"&gt;Falcon Ridge Parkway&lt;/div&gt;<br>&lt;div 
  class="w3-highway-red"&gt;STOP&lt;/div&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_highway" target="_blank">
  Try It Yourself »</a>
</div>
<hr>

<h2>US Highway Colors</h2>
<table class="w3-table-all w3-large">
<tr><td class="w3-highway-brown">w3-highway-brown</td></tr>
<tr><td class="w3-highway-red">w3-highway-red</td></tr>
<tr><td class="w3-highway-orange">w3-highway-orange</td></tr>
<tr><td class="w3-highway-schoolbus">w3-highway-schoolbus</td></tr>
<tr><td class="w3-highway-yellow">w3-highway-yellow</td></tr>
<tr><td class="w3-highway-green">w3-highway-green</td></tr>
<tr><td class="w3-highway-blue">w3-highway-blue</td></tr>
</table>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_highway_red" target="_blank">
  Try It Yourself »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_highway_lib" target="_blank">
  Try All »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/lib/w3-colors-highway.css" target="_blank">
  Download the CSS »</a>
</div>
<p>The highway colors are defined in <a href="/colors/colors_fs595.asp">Federal 
Standard 595</a>.</p>
<hr>

<h2>US Safety Colors</h2>
<table class="w3-table-all w3-large">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_safety-red" target="_blank">
  Try It Yourself »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_safety" target="_blank">
  Try All »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/lib/w3-colors-safety.css" target="_blank">
  Download the CSS »</a>
</div>
<p>The US safety colors are defined in <a href="/colors/colors_fs595.asp">
Federal Standard 595</a>.</p>
...
<h2>European Signal Colors</h2>
<table class="w3-table-all w3-large">
<tr><td class="w3-signal-yellow">w3-signal-yellow</td></tr>
<tr><td class="w3-signal-orange">w3-signal-orange</td></tr>
<tr><td class="w3-signal-red">w3-signal-red</td></tr>
<tr><td class="w3-signal-violet">w3-signal-violet</td></tr>
<tr><td class="w3-signal-blue">w3-signal-blue</td></tr>
<tr><td class="w3-signal-green">w3-signal-green</td></tr>
<tr><td class="w3-signal-grey">w3-signal-grey</td></tr>
<tr><td class="w3-signal-brown">w3-signal-brown</td></tr>
<tr><td class="w3-signal-white">w3-signal-white</td></tr>
<tr><td class="w3-signal-black">w3-signal-black</td></tr>
</table>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="w3-signal-red"&gt;Stop&lt;/div&gt;<br>&lt;div 
  class="w3-signal-yellow"&gt;Wait&lt;/div&gt;<br>&lt;div class="w3-signal-green"&gt;Go&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_signal" target="_blank">
  Try It Yourself »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_signal_lib" target="_blank">
  Try All »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/lib/w3-colors-signal.css" target="_blank">
  Download the CSS »</a>
</div>
<p>The European signal colors are defined in the <a href="/colors/colors_ral.asp">
RAL Color Standard</a>.</p>
<hr>

<hr>
<h2>Vivid Colors</h2>
<table class="w3-table-all w3-large">
<tr><td style="color:#fff;background-color:#ffb5bA">w3-vivid-pink</td></tr>
<tr><td style="color:#fff;background-color:#be0032">w3-vivid-red</td></tr>
<tr><td style="color:#fff;background-color:#f38400">w3-vivid-orange</td></tr>
<tr><td style="color:#fff;background-color:#f3c300">w3-vivid-yellow</td></tr>
<tr><td style="color:#fff;background-color:#008856">w3-vivid-green</td></tr>
<tr><td style="color:#fff;background-color:#00a1c2">w3-vivid-blue</td></tr>
<tr><td style="color:#fff;background-color:#9065ca">w3-vivid-violet</td></tr>
<tr><td style="color:#fff;background-color:#9a4eae">w3-vivid-purple</td></tr>
<tr><td style="color:#fff;background-color:#000">w3-vivid-black</td></tr>
<tr><td style="color:#000;background-color:#fff">w3-vivid-white</td></tr>
<tr><td style="color:#fff;background-color:#ffb7a5">w3-vivid-yellowish-pink</td></tr>
<tr><td style="color:#fff;background-color:#e25822">w3-vivid-reddish-orange</td></tr>
<tr><td style="color:#fff;background-color:#f6a600">w3-vivid-orange-yellow</td></tr>
<tr><td style="color:#fff;background-color:#dcd300">w3-vivid-greenish-yellow</td></tr>
<tr><td style="color:#fff;background-color:#8db600">w3-vivid-yellow-green</td></tr>
<tr><td style="color:#fff;background-color:#27a64c">w3-vivid-yellowish-green</td></tr>
<tr><td style="color:#fff;background-color:#008882">w3-vivid-bluish-green</td></tr>
<tr><td style="color:#fff;background-color:#0085a1">w3-vivid-greenish-blue</td></tr>
<tr><td style="color:#fff;background-color:#30267a">w3-vivid-purplish-blue</td></tr>
<tr><td style="color:#fff;background-color:#870074">w3-vivid-reddish-purple</td></tr>
<tr><td style="color:#fff;background-color:#ce4676">w3-vivid-purplish-red</td></tr>
</table>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="w3-vivid-red"&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the 
  United Kingdom,<br>&nbsp; with a metropolitan area of over 9 million 
  inhabitants.&lt;/p&gt;<br>&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_vivid" target="_blank">
  Try It Yourself »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/lib/w3-colors-vivid.css" target="_blank">
  Download the CSS »</a>
</div>
<p>The vivid colors are defined in <a href="/colors/colors_nbs.asp">ISCC-NBS</a>.</p>

<hr>
<h2>Food Colors</h2>
<table class="w3-table-all w3-large">
<tr><td class="w3-food-apple">w3-food-apple</td></tr>
<tr><td class="w3-food-aspargus">w3-food-aspargus</td></tr>
<tr><td class="w3-food-apricot">w3-food-apricot</td></tr>
<tr><td class="w3-food-aubergine">w3-food-aubergine</td></tr>
<tr><td class="w3-food-avocado">w3-food-avocado</td></tr>
<tr><td class="w3-food-banana">w3-food-banana</td></tr>
<tr><td class="w3-food-butter">w3-food-butter</td></tr>
<tr><td class="w3-food-blueberry">w3-food-blueberry</td></tr>
<tr><td class="w3-food-cherry">w3-food-cherry</td></tr>
<tr><td class="w3-food-chocolate">w3-food-chocolate</td></tr>
<tr><td class="w3-food-cranberry">w3-food-cranberry</td></tr>
<tr><td class="w3-food-coffee">w3-food-coffee</td></tr>
<tr><td class="w3-food-egg">w3-food-egg</td></tr>
<tr><td class="w3-food-grape">w3-food-grape</td></tr>
<tr><td class="w3-food-kiwi">w3-food-kiwi</td></tr>
<tr><td class="w3-food-lemon">w3-food-lemon</td></tr>
<tr><td class="w3-food-lime">w3-food-lime</td></tr>
<tr><td class="w3-food-mango">w3-food-mango</td></tr>
<tr><td class="w3-food-mushroom">w3-food-mushroom</td></tr>
<tr><td class="w3-food-mustard">w3-food-mustard</td></tr>
<tr><td class="w3-food-mint">w3-food-mint</td></tr>
<tr><td class="w3-food-olive">w3-food-olive</td></tr>
<tr><td class="w3-food-orange">w3-food-orange</td></tr>
<tr><td class="w3-food-pea">w3-food-pea</td></tr>
<tr><td class="w3-food-peach">w3-food-peach</td></tr>
<tr><td class="w3-food-pear">w3-food-pear</td></tr>
<tr><td class="w3-food-pistachio">w3-food-pistachio</td></tr>
<tr><td class="w3-food-plum">w3-food-plum</td></tr>
<tr><td class="w3-food-raspberry">w3-food-raspberry</td></tr>
<tr><td class="w3-food-saffron">w3-food-saffron</td></tr>
<tr><td class="w3-food-salmon">w3-food-salmon</td></tr>
<tr><td class="w3-food-spearmint">w3-food-spearmint</td></tr>
<tr><td class="w3-food-squash">w3-food-squash</td></tr>
<tr><td class="w3-food-strawberry">w3-food-strawberry</td></tr>
<tr><td class="w3-food-tomato">w3-food-tomato</td></tr>
<tr><td class="w3-food-wheat">w3-food-wheat</td></tr>
<tr><td class="w3-food-wine">w3-food-wine</td></tr>
</table>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="w3-food-apple"&gt;Apple&lt;/div&gt;<br>&lt;div 
  class="w3-food-banana"&gt;Banana&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_food" target="_blank">
  Try It Yourself »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_food_lib" target="_blank">
  Try All »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/lib/w3-colors-food.css" target="_blank">
  Download the CSS »</a>
</div>
<hr>

<h2>Camouflage Colors</h2>
<table class="w3-table-all w3-large">
<tr><td class="w3-camo-brown">w3-camo-brown</td></tr>
<tr><td class="w3-camo-red">w3-camo-red</td></tr>
<tr><td class="w3-camo-olive">w3-camo-olive</td></tr>
<tr><td class="w3-camo-field">w3-camo-field</td></tr>
<tr><td class="w3-camo-earth">w3-camo-earth</td></tr>
<tr><td class="w3-camo-sand">w3-camo-sand</td></tr>
<tr><td class="w3-camo-tan">w3-camo-tan</td></tr>
<tr><td class="w3-camo-sandstone">w3-camo-sandstone</td></tr>
<tr><td class="w3-camo-dark-green">w3-camo-dark-green</td></tr>
<tr><td class="w3-camo-forest">w3-camo-forest</td></tr>
<tr><td class="w3-camo-light-green">w3-camo-light-green</td></tr>
<tr><td class="w3-camo-green">w3-camo-green</td></tr>
<tr><td class="w3-camo-dark-grey">w3-camo-dark-grey</td></tr>
<tr><td class="w3-camo-grey">w3-camo-grey</td></tr>
<tr><td class="w3-camo-black">w3-camo-black</td></tr>
</table>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="w3-camo-earth"&gt;Camouflaged Truck&lt;/div&gt;<br>&lt;div 
  class="w3-camo-grey"&gt;Camouflaged Ship&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_camo" target="_blank">
  Try It Yourself »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_camo_lib" target="_blank">
  Try All »</a>
  &nbsp;
<a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/lib/w3-colors-camo.css" target="_blank">
  Download the CSS »</a>
</div>
<p>The camouflage colors are defined in <a href="/colors/colors_fs595.asp">
Federal Standard 595</a>.</p>
