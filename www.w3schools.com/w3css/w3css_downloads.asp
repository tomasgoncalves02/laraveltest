...
<h1>W3.CSS <span class="color_h1">Downloads</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_references.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>

<hr>
<h2>Download W3.CSS</h2>

<p>Download W3.CSS from this link:
<strong><a href="https://www.w3schools.com/w3css/4/w3.css" target="_blank">
https://www.w3schools.com/w3css/4/w3.css</a></strong></p>

<hr>
<h2>W3.CSS is Free</h2>
<p>W3.CSS is free to use. No license is necessary.</p>
<hr>
<h2>How To use W3.CSS</h2>
<p>To use W3.CSS, just add a link to &quot;w3.css&quot; in your web pages:</p>
<div class="w3-example">
 <h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br>&lt;meta 
  name="viewport" content="width=device-width, initial-scale=1"&gt;<br><br>
  <strong>&lt;link rel="stylesheet" 
  href="https://www.w3schools.com/w3css/4/w3.css"&gt;</strong></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_dl_w3css" target="_blank">Try It Yourself &raquo;</a>
</div>

<p>Or download w3.css and run it from your own web site:</p>
<div class="w3-example">
 <h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br>&lt;meta 
  name="viewport" content="width=device-width, initial-scale=1"&gt;<br><br>
  <strong>&lt;link rel="stylesheet" 
  href="w3.css"&gt;</strong></div>
 <br>
</div>

<p>If you put w3.css in a subfolder, add the folder name between slashes:</p>
<div class="w3-example">
 <h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br>&lt;meta 
  name="viewport" content="width=device-width, initial-scale=1"&gt;<br><br>
  <strong>&lt;link rel="stylesheet" 
  href="/<em>foldername</em>/w3.css"&gt;</strong></div>
</div>

<p>If you place w3.css at the root of your web, add a slash:</p>
<div class="w3-example">
 <h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br>&lt;meta 
...
<hr>
<h2>Changelog</h2>
<p>Download version 4.13 from this link:
<strong><a href="https://www.w3schools.com/w3css/4/w3.css" target="_blank">
https://www.w3schools.com/w3css/4/w3.css</a></strong></p>
...
<table class="w3-table w3-bordered w3-striped w3-border">
 ...
 <tr>
  <td>4.15</td>
  <td>12/2020</td>
  <td>Supplemented w3-serif with<br>w3-sans-serif<br>w3-cursive<br>w3-monospace</td>
 </tr>
 <tr>
  <td>4.14</td>
  <td>11/2020</td>
  <td>Supplemented w3-padding with<br>w3-padding-top-64<br>w3-padding-top-48<br>w3-padding-top-32<br>w3-padding-top-24</td>
 </tr>
 <tr>
  <td>4.13</td>
  <td>06/2019</td>
  <td>Adapted to minor changes in Normalize.css</td>
 </tr>
 <tr>
  <td>4.12</td>
  <td>11/2018</td>
  <td>Added w3-stretch</td>
 </tr>
 <tr>
  <td>4.11</td>
  <td>10/2018</td>
  <td>Added w3-auto<br>
  Changed margin:auto to margin-left:auto and margin-right:auto in w3-content
  </td>
 </tr>
 <tr>
  <td>4.10</td>
  <td>02/2018</td>
  <td>
  Added "outline:0" to w3-bar-item in w3-bar and w3-bar-block
  </td>
 </tr>
 <tr>
  <td>4.09</td>
  <td>12/2017</td>  <td>
  Removed "outline:0" from buttons
  </td>
 </tr>
 <tr>
  <td>4.08</td>
  <td>10/2017</td>
  <td>
  Added "z-index:1" to w3-dropdown-content
  </td>
 </tr>
 <tr>
  <td>4.07</td>
  <td>08/2017</td>
  <td>
  Added "vertical-align:middle" to images
  </td>
 </tr>
 <tr>
  <td>4.06</td>
  <td>08/2017</td>
  <td>
  Added version 3 color classes to borders, hoverable borders and hoverable text
  </td>
 </tr>
 <tr>
  <td>4.05</td>
  <td>06/2017</td>
  <td>
  Added "display:block" to w3-responsive
  </td>
 </tr>
 <tr>
  <td>4.04</td>
  <td>04/2017</td>
  <td>
  Added "float:none" to w3-bar-item inside w3-bar-block
  </td>
 </tr>
 <tr>
  <td>4.03</td>
  <td>03/2017</td>
  <td>
  Corrected a minor bug in "w3-col m3"</td>
 </tr>
 <tr>
  <td>4.02</td>
  <td>03/2017</td>
  <td>
  Added version 3 text colors</td>
 </tr>
<tr>
  <td>4.01</td>
  <td>03/2017</td>
  <td>
  Lightened the color gray/grey<br>
...
<hr>
<h2>GitHub Repositiory</h2>
<div class="w3-panel w3-note">
<p>GitHub repository is:
<a target="_blank" href="https://github.com/JaniRefsnes/w3css">https://github.com/JaniRefsnes/w3css</a></p>
</div>

<hr>
<h2>Validating W3.CSS</h2>
<p>Validating W3.CSS  might return some errors.</p>
<div class="w3-panel w3-note">
  <p>You will often get some errors when you run W3C validations.<br>There will 
  always be some browser specific values outside the current W3C specification.</p>
</div>

<table class="w3-table-all">
<thead><th style="width:30%">Property</th><th>Description</th></thead>

<tr>
<td><strong>pointer-events</strong></td>
<td>Invalid property in CSS3, but suggested for CSS4.<br>
Used in W3.CSS to remove hand pointer from disabled elements.</td>
</tr>

<tr>
<td><strong>user-select</strong></td>
<td>Invalid property in CSS3, but suggested for CSS4.<br>
Used in W3.CSS to remove text selection from clickable elements.</td>
</tr>

<tr>
<td>pseudo-class <strong>:valid</strong></td>
<td>Invalid value in CSS3, but suggested for CSS4.<br>
Used in W3.CSS to indicate valid input.</td>
</tr>

<tr>
<td><strong>@-webkit-keyframes</strong></td>
<td>Added to W3.CSS to make animations work in webkit browsers (older versions of Chrome, Safari, and Opera).</td>
</tr>
</table>

<hr>
<h2>Customize W3.CSS</h2>
<p>W3.CSS includes basic fonts and font sizes.</p>
<p>You can customize W3.CSS by changing these settings:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
html {<br>&nbsp; font-family: Verdana, sans-serif;<br>&nbsp; font-size: 15px;<br>
&nbsp;
line-height: 1.5;<br>&nbsp; font-weight: normal;<br>}<br>
<br>h1, h2, h3, h4, h5, h6 {<br>&nbsp; font-family: &quot;Segoe UI&quot;, Verdana, sans-serif;<br>
&nbsp; font-weight: 400;<br>&nbsp; line-height: 1;<br>&nbsp; margin: 
20px 0;<br>}<br>
<br>h1 a, h2 a, h3 a, h4 a, h5 a, h6 a {font-weight: inherit;}<br>h1 
{font-size: 36px}<br>h2 {font-size: 30px}<br>h3 {font-size: 24px}<br>h4 
{font-size: 20px}<br>h5 {font-size: 18px}<br>h6 {font-size: 16px}<br><br>hr 
{<br>&nbsp; height: 0;<br>&nbsp; border: 0;<br>&nbsp; border-top: 1px solid 
#eee;<br>&nbsp; margin: 20px 0;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_dl_basic" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
<h2>W3.CSS is Normalized</h2>
<p>Normalizing a style sheet is done to:</p>
<ul>
 <li>Correct browser bugs</li>
 <li>Remove browser inconsistencies</li>
 <li>Assure common browser defaults</li>
 <li>Normalize the styles of all HTML elements</li>
 <li>Add CSS improvements</li>
</ul>
<p>An <strong>extract</strong> from
Normalize.css is used in W3.CSS.</p>
<p>This makes W3.CSS display HTML consistently in all browsers, and in line with 
