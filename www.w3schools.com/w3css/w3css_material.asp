...
<html lang="en-US">
<head>
<title>W3.CSS Material Design</title>
<meta charset="utf-8">
...
<h1>W3.CSS <span class="color_h1">Material Design</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="w3css_case.asp">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="w3css_validation.asp">Next &#10095;</a>
</div>

<hr>
<h2>Material Design</h2>
<p>Material Design was designed by Google in 2014 and has later been adopted in many Google applications.</p>

<p>Material Design uses elements that remind us of paper and ink. In addition the elements have realistic shadows 
and hover effects.</p>
...
<h2>Material Design Look Using W3.CSS</h2>
<p>W3.CSS is the perfect stylesheet for designing applications with a "Material Design" look:</p>
...
<div class="w3-container w3-content" style="max-width:600px;min-width:400px">
 ...
 <span class="w3-right w3-padding w3-opacity w3-hover-red">X</span>
 <p class="w3-text-blue"><b>email.zip</b></p>
 <p>https://www.w3schools.com/lib/email.zip</p>
 <p class="w3-text-blue"><a href="javascript:void(0)">Show in folder</a></p>
 </div>
...
<p><a href="tryit.asp?filename=tryw3css_material_download" target="_blank" class="w3-btn">Try it Yourself</a></p>
<hr>
...
<hr>
<h2>Material Design Look (Color Themes)</h2>

<div class="w3-row xw3-padding w3-text-white" style="background-color:#d09c00">
  <div class="w3-quarter">
    <div class="w3-bar w3-xlarge">
      <a href="javascript:void(0)" class="w3-bar-item w3-button"><i class="fa fa-bars"></i></a>
    </div>
  </div>

  <div class="w3-half w3-xlarge w3-padding">
    <input type="text" class="w3-border-0" style="background-color:#ffc107;width:100%">
  </div>

  <div class="w3-quarter">
    <div class="w3-bar w3-xlarge">
      <a href="javascript:void(0)" class="w3-bar-item w3-button w3-left"><i class="fa fa-search"></i></a>
      <a href="javascript:void(0)" class="w3-bar-item w3-button w3-right"><img class="w3-hide-small w3-circle" src="img_avtar.jpg" style="height:32px;"></a>
    </div>
  </div>
</div>

<div style="background-color:#eab000" class="w3-container w3-padding-32">
  <h1>Places to Visit</h1>
</div>

<div class="w3-row-padding" style="background-color:#ffc107">
...
<div class="w3-container w3-white">
<h4>Vernazza</h4>
<p>Vernazza is another of the five towns in the region.
...
<div class="w3-container w3-text-white" style="background-color:#9c7500">
<p class="w3-large">Europe Italy</p>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_material_color_themes&stacked=h" target="_blank">Try it Yourself</a>
</p>
<hr>
<h2>Material Design Look (Navigation Bars)</h2>

<h3>Status Bar:</h3>
<div class="w3-container w3-padding-small w3-text-white" style="background-color:#0a69b7">
  <div class="w3-right">
...
<h3>Toolbar:</h3>
<div class="w3-bar w3-blue w3-xlarge" style="background-color:#0a69b7">
  <a class="w3-bar-item w3-button" href="javascript:void(0)"><i class="fa fa-bars"></i></a>
  <span class="w3-bar-item">Title</span>
  <a class="w3-bar-item w3-button w3-right" href="javascript:void(0)"><i class="fa fa-search"></i></a>
</div>

<h3>Tab Bar / Search Bar:</h3>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryw3css_material_navigation" target="_blank">Try it Yourself</a></p>

<hr>
<h2>Material Design Look (Colorful Cards)</h2>

<div class="w3-row-padding" style="margin:16px -16px">

<div class="w3-third">
  <div class="w3-card-4">
    <img src="img_md_sport.jpg" style="width:100%;height:200px">
...
<div class="w3-third">
  <div class="w3-card-4">
    <img src="img_md_globe.jpg" style="width:100%;height:200px">
    <div class="w3-bar w3-blue">
...
<div class="w3-third">
  <div class="w3-card-4">
    <img src="img_md_music.jpg" style="width:100%;height:200px">
