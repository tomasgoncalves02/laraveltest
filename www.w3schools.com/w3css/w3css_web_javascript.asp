...
<h1>Using a JavaScript Library</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_web_css.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_web_layout.asp">Next &#10095;</a>
</div>
...
<hr>
<h2>How to - Slideshow</h2>
<div class="w3-example">
<h3>JavaScript Example</h3>

<div class="w3-code notranslate htmlHigh">
  &lt;img class="nature" src="img_snowtops.jpg" width="100%"&gt;<br>
  &lt;img class="nature" src="img_mountains.jpg" width="100%"&gt;<br>
  &lt;img class="nature" src="img_nature.jpg" width="100%"&gt;<br><br>
  &lt;script&gt;<br>
  w3.slideshow(".nature", 1500);<br>&lt;/script&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryweb_js_slideshow" target="_blank">
  Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Hide/Show HTML Elements</h2>

<div class="w3-example">
<h3>JavaScript Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;p&gt;<br>&lt;button onclick="w3.hide('#London')"&gt;Hide London&lt;/button&gt;<br>&lt;button 
  onclick="w3.show('#London')"&gt;Show London&lt;/button&gt;<br>&lt;/p&gt;<br><br>&lt;div 
  id="London" class="w3-container w3-red"&gt;<br>&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is 
  the capital city of England.&lt;/p&gt;<br>&lt;/div&gt;<br><br>&lt;div id="Paris" 
  class="w3-container w3-green"&gt;<br>&nbsp; &lt;h2&gt;Paris&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Paris is the capital of 
  France.&lt;/p&gt; <br>&lt;/div&gt;<br><br>&lt;div id="Tokyo" class="w3-container w3-blue"&gt;<br>
  &nbsp;
  &lt;h2&gt;Tokyo&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Tokyo is the capital of Japan.&lt;/p&gt;<br>&lt;/div&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryweb_js_show" target="_blank">
  Try it Yourself &raquo;</a>
</div>

<h2>Congratulations!</h2>
<p>You have just learned the basics of using a JavaScript library.</p>
