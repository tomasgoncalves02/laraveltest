...
<h1>W3.CSS Google Fonts</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_fonts.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_text.asp">Next &#10095;</a>
</div>

<div class="w3-panel w3-info">

<p>With W3.CSS it is extremely easy to add new fonts.
<ul>
...
<p class="w3-roboto">This is Roboto</p>
<p class="w3-sofia">This is Sofia</p>
<p class="w3-sofia font-effect-fire">Sofia on Fire</p>
<p class="w3-tangerine">Making the Web!</p>
<p class="w3-lobster">Making the Web!</p>
<p class="w3-lobster font-effect-shadow-multiple">Making the Web!</p>
<p class="w3-allerta">Making the Web!</p>
<p class="w3-allerta w3-black w3-center">Making the Web!</p>

<hr>
<h2>Using Google Fonts</h2>
<p>Google Fonts are free to use, and have more than 1000 fonts to choose from.</p>
<p>In the head of your web page, link to a Google font:</p>
...
<p>Then add the CSS about where to use it:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
body,h1,h2,h3,h4,h5,h6 {font-family: Roboto, sans-serif;}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_roboto" target="_blank">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_google" target="_blank">
Try It Yourself &raquo;</a>
</div>


<hr>
<h2>Create a Font Class</h2>
...
<p>In your web page, use the font class:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;p class=&quot;w3-sofia&quot;&gt;Making the Web!&lt;/p&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_class" target="_blank">
 Try It Yourself &raquo;</a>
</div>
<div class="w3-sofia">
Making the Web!
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_intro" target="_blank">
 Try It Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_lobster" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_effects" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_fonts_allerta" target="_blank">Try It Yourself &raquo;</a>
</div>
