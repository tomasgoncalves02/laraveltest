...
<html lang="en-US">
<head>
<title>W3.CSS Color Schemes</title>
<meta charset="utf-8">
...
<h1>W3.CSS <span class="color_h1">Color Schemes</span></h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="w3css_color_libraries.asp">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="w3css_color_themes.asp">Next &#10095;</a>
</div>

<hr>
<h2>Color Schemes</h2>
<p>The colors used in the design of a web site is often called a color scheme:</p>
<table style="width:100%;text-align:center">
<tr style="height:150px">
<td style="width:20%;background-color:#7e9a9a">#7e9a9a</td>
<td style="width:20%;background-color:#f6d8ac">#f6d8ac</td>
<td style="width:20%;background-color:#db9833">#db9833</td>
<td style="width:20%;background-color:#2a6592;color:white">#2a6592</td>
<td style="width:20%;background-color:#8ec3eb">#8ec3eb</td>
</tr>
</table>
<p>The purpose of a color scheme is to create an aesthetic feeling of style and appeal.</p>
<hr>

<div class="w3-row">
<div class="w3-third w3-center">
<h3>Monochromatic</h3>
<img alt="Monochromatic" src="img_monochromatic.png" style="width:100%;max-width:300px">
</div>
<div class="w3-third w3-center">
<h3>Analogous</h3>
<img alt="Analogous" src="img_analogous.png" style="width:100%;max-width:300px">
</div>
<div class="w3-third w3-center">
<h3>Complementary</h3>
<img alt="Complementary" src="img_complementary.png" style="width:100%;max-width:300px">
</div>
</div>
<p><a href="/colors/colors_schemes.asp">Read more about color schemes...</a></p>


<hr>
<h2>Achromatic Color Schemes</h2>
<p>The black on white achromatic color scheme is the default color scheme for a web page:</p>
<div class="w3-panel w3-border">
<p>It uses a white background with a black text. </p>
</div>
<p>The white on black achromatic color scheme is often preferred for smaller 
devices:</p>
<div class="w3-panel w3-black">
<p>It uses a black background with a white text. </p>
</div>
White on black requires less energy (improves battery life) on most display technologies.
<hr>
<h2>Monochromatic Color Schemes</h2>

<p>Monochromatic color schemes use a single color width different additions of black, gray, and white.</p>
<table class="w3-table-all">
<tr>
<td style="width:12.5%;background-color:#edf4fb">&nbsp;</td>
<td style="width:12.5%;background-color:#c2dbf0">&nbsp;</td>
<td style="width:12.5%;background-color:#85b7e2">&nbsp;</td>
<td style="width:12.5%;background-color:#4992d3">&nbsp;</td>
<td style="width:12.5%;background-color:#296ca8">&nbsp;</td>
<td style="width:12.5%;background-color:#1a456b">&nbsp;</td>
<td style="width:12.5%;background-color:#153755">&nbsp;</td>
<td style="width:12.5%;background-color:#102940">&nbsp;</td>
</tr>
</table>

<p>The color scheme above was generated by the
<a href="w3css_color_generator.asp">W3.CSS color generator</a>. </p>
<p>Monochromatic color schemes often have a more subtle and peaceful energy, 
with especially with blue or green colors.</p>
<img alt="Flag Norway" src="img_blue_mono.jpg">
<p>In the chapter <a href="w3css_color_themes.asp">W3.CSS Color Themes</a> you 
will find a lot of monochromatic color themes.</p>
<p>You can read more about color schemes in the chapter
<a href="/colors/colors_schemes.asp">Color Schemes</a> in our
<a href="/colors/default.asp">Colors Tutorial</a>.</p>

<hr>
<h2>Flat Design Color Schemes</h2>
<p>The theory of flat design is covered in the chapter
<a href="w3css_trends.asp">W3.CSS Trends</a>.</p>
<p>Colors play an important part in flat design. Flat design color schemes often 
use more colors than traditional color schemes.</p>
<p>The color schemes used in W3.CSS is inspired by Google Material Design:</p>

<div class="w3-row">
<div class="w3-half w3-container w3-red">
<h2>London</h2>
<p>London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.</p>
<p><a target="_blank" href="tryit.asp?filename=tryw3css_colors_red">Red</a></p>
</div>
<div class="w3-half w3-container w3-green">
<h2>London</h2>
<p>London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.</p>
<p><a target="_blank" href="tryit.asp?filename=tryw3css_colors_green">Green</a></p>
</div>
</div>
...
<h2>London</h2>
<p>London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.</p>
<p><a target="_blank" href="tryit.asp?filename=tryw3css_colors_orange">Orange</a></p>
</div>
<div class="w3-half w3-container w3-blue-gray">
<h2>London</h2>
<p>London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.</p>
<p><a target="_blank" href="tryit.asp?filename=tryw3css_colors_blue-gray">Blue Gray</a></p>
</div>
</div>
<p><a href="w3css_color_flat.asp">More Flat Design Color Schemes...</a></p>
<br>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="w3css_color_libraries.asp">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="w3css_color_themes.asp">Next &#10095;</a>
