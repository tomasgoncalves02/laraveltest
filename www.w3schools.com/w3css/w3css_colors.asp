...
<link rel="stylesheet" href="/lib/w3-colors-win8.css">
<link rel="stylesheet" href="/lib/w3-colors-highway.css">
<link rel="stylesheet" href="/lib/w3-colors-2017.css">
<style>
.w3-tile{float:left;height:110px;width:110px;margin:4px;text-align:center;padding-top:30px;font-size:18px}
</style>
</head>
<body>
...
<a class="w3-left w3-btn" href="w3css_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_containers.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The default color scheme used in W3.CSS is inspired by Material Design Colors
(colors used in marketing, road signs, and sticky notes).</p>
</div>
<hr>

<h2>Coloring HTML Elements</h2>
<p>The <strong>w3-<em>color</em></strong> and <strong>w3-text-<em>color</em></strong> classes can be used to color 
any HTML element:</p>
...
<h3>Buttons:</h3>
<button class="w3-btn w3-margin-bottom w3-large w3-teal">Teal</button>
<button class="w3-btn w3-margin-bottom w3-large w3-blue">Blue</button>
<button class="w3-btn w3-margin-bottom w3-large w3-yellow">Yellow</button>
<button class="w3-btn w3-margin-bottom w3-large w3-orange">Orange</button>
<button class="w3-btn w3-margin-bottom w3-large w3-red">Red</button>
<button class="w3-btn w3-margin-bottom w3-large w3-purple">Purple</button>
...
<h3>Borders:</h3>
<div style="width:50%">
<div class="w3-panel w3-border w3-border-red"><p>Red</p></div>
<div class="w3-panel w3-border w3-border-green"><p>Green</p></div>
<div class="w3-panel w3-border w3-border-blue"><p>Blue</p></div>
<div class="w3-panel w3-border w3-border-yellow"><p>Yellow</p></div>
<div class="w3-panel w3-border w3-border-gray"><p>Gray</p></div>
<div class="w3-panel w3-border w3-border-black"><p>Black</p></div>
</div>
...
<p>The <strong>w3-<em>color</em></strong> classes set the background color for any HTML element:</p>
...
&lt;div class="w3-red"&gt;<br>
&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the United Kingdom,<br>&nbsp; with a metropolitan area of over 9 million inhabitants.&lt;/p&gt;<br>
&lt;/div&gt;<br><br>&lt;div class="w3-yellow"&gt;<br>
&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the United Kingdom,<br>&nbsp; with a metropolitan area of over 9 million inhabitants.&lt;/p&gt;<br>
&lt;/div&gt;<br><br>&lt;div class="w3-gray"&gt;<br>
&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the United Kingdom,<br>&nbsp; with a metropolitan area of over 9 million inhabitants.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors" target="_blank">Try It Yourself &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p>The colors <strong>gray</strong> and <strong>grey</strong> are interchangeable 
in all W3.CSS classes.</p>
</div>

<hr>

<h2>Text Colors</h2>
<p>The <strong>w3-text-<em>color</em></strong> classes set the text color of any HTML element:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class="w3-text-red"&gt;<br>
&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the United Kingdom,<br>&nbsp; with a metropolitan area of over 9 million inhabitants.&lt;/p&gt;<br>
&lt;/div&gt;
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3css_colors_text" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>The <strong>w3-hover-<em>color</em></strong> classes define the background hover color for any HTML element:</p>
<div class="w3-container w3-hover-red w3-orange">
  <h2>London</h2>
  <p>London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.</p>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;w3-container w3-orange w3-hover-red&quot;&gt;<br>&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.&lt;/p&gt;<br>&lt;/div&gt;
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_hover" target="_blank">Try It Yourself &raquo;</a>
</div>

<p>The <strong>w3-hover-text-<em>color</em></strong> classes define the text hover color for any HTML element:</p>
<div class="w3-container w3-hover-text-white w3-orange">
  <h2>London</h2>
  <p>London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.</p>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;w3-container w3-orange w3-hover-text-white&quot;&gt;<br>&nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the most populous city in the United Kingdom, with a metropolitan area of over 9 million inhabitants.&lt;/p&gt;<br>
  &lt;/div&gt;
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_colors_hover_text" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Color libraries</h2>
<p>In addition to standard W3.CSS colors, W3.CSS can also use colors from a lot of different color libraries:</p>
<h2>Windows Colors:</h2>
<div class="w3-row w3-stretch">
<div class="w3-tile w3-win8-lime">Lime</div>
<div class="w3-tile w3-win8-green">Green</div>
<div class="w3-tile w3-win8-olive">Olive</div>
<div class="w3-tile w3-win8-emerald">Emerald</div>
<div class="w3-tile w3-win8-teal">Teal</div>
<div class="w3-tile w3-win8-steel">Steel</div>
<div class="w3-tile w3-win8-cyan">Cyan</div>
<div class="w3-tile w3-win8-blue">Blue</div>
<div class="w3-tile w3-win8-indigo">Indigo</div>
<div class="w3-tile w3-win8-cobalt">Cobalt</div>
<div class="w3-tile w3-win8-violet">Violet</div>
<div class="w3-tile w3-win8-mauve">Mauve</div>

<div class="w3-tile w3-win8-pink">Pink</div>
<div class="w3-tile w3-win8-magenta">Magenta</div>
<div class="w3-tile w3-win8-red">Red</div>
<div class="w3-tile w3-win8-orange">Orange</div>
<div class="w3-tile w3-win8-amber">Amber</div>
<div class="w3-tile w3-win8-yellow">Yellow</div>
<div class="w3-tile w3-win8-brown">Brown</div>
<div class="w3-tile w3-win8-taupe">Taupe</div>
<div class="w3-tile w3-win8-sienna">Sienna</div>
<div class="w3-tile w3-win8-crimson">Crimson</div>
</div>
<p><a href="w3css_color_win8.asp">Click here to Learn more about Windows colors</a></p>
<hr>
<h2>Fashion Colors:</h2>
<div class="w3-row w3-stretch" xstyle="margin:16px -4px">
<div class="w3-tile w3-2017-flame">Flame</div>
<div class="w3-tile w3-2017-greenery">Greenery</div>
<div class="w3-tile w3-2017-marina">Marina</div>
<div class="w3-tile w3-2017-primrose-yellow">Primrose<br>Yellow</div>
<div class="w3-tile w3-2017-neutral-gray">Neutral Gray</div>
<div class="w3-tile w3-2017-shaded-spruce">Shaded<br>Spruce</div>
<div class="w3-tile w3-2017-navy-peony">Navy<br>Peony</div>
<div class="w3-tile w3-2017-tawny-port">Tawny<br>Port</div>
</div>
<p><a href="w3css_color_fashion.asp">Click here to Learn more about fashion colors</a></p>
<hr>
<h2>Highway Colors:</h2>
<div class="w3-row w3-stretch" xstyle="margin:16px -4px">
<div class="w3-tile w3-highway-red">Red</div>
<div class="w3-tile w3-highway-green">Green</div>
<div class="w3-tile w3-highway-blue">Blue</div>
<div class="w3-tile w3-highway-yellow">Yellow</div>
</div>
<p><a href="w3css_color_libraries.asp">Click here to Learn more about color libraries</a></p>

<p>You will learn a lot more about colors in later chapters of this tutorial.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="w3css_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="w3css_containers.asp">Next &#10095;</a>
